...
``opencodon_cli/main.py:main()`` (god-file Phase 2); handler injected to avoid
importing ``main``.
"""
...
def _add_server_runtime_args(parser) -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "where npm may not be available. Pre-build with: "
            "npm run build --workspace @opencodon/web"
        ),
    )
    parser.add_argument(
        "--isolated",
