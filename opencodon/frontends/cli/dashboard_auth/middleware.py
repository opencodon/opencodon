...
from opencodon.frontends.cli.dashboard_auth import list_session_providers
from opencodon.frontends.cli.dashboard_auth.audit import AuditEvent, audit_log
from opencodon.frontends.cli.dashboard_auth.base import (
...
from opencodon.frontends.cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
...
def _unauth_response(request: Request, *, reason: str) -> Response:
    ...
    """
    from opencodon.frontends.cli.dashboard_auth.prefix import prefix_from_request
...
def _auto_sso_response(request: Request) -> Response | None:
    ...
    from opencodon.frontends.cli.dashboard_auth.cookies import detect_https
    set_sso_attempt_cookie(
...
async def gated_auth_middleware(
    ...
    if session is None:
        ...
        from opencodon.frontends.cli.dashboard_auth.cookies import clear_session_cookies
        from opencodon.frontends.cli.dashboard_auth.prefix import prefix_from_request
