...
_UPDATE_CRITICAL_FILES = (
    "opencodon_cli/main.py",
    "opencodon_cli/config.py",
    ...
    "opencodon/frontends/cli/main.py",
    "opencodon/frontends/cli/config.py",
    "opencodon/frontends/cli/__init__.py",
    "opencodon/frontends/cli/web_server.py",
    "opencodon/frontends/cli/shell.py",
    "opencodon/core/run_agent.py",
    "opencodon/tools/model_tools.py",
)
...
def _build_web_ui(web_dir: Path, *, fatal: bool = False) -> bool:
    ...
    project_root = web_dir.parent.parent if web_dir.parent.name == "apps" else web_dir.parent
    dist_index = project_root / "opencodon_cli" / "web_dist" / "index.html"
    try:
