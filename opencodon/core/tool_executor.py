...
from opencodon.core.tool_guardrails import ToolGuardrailDecision
...
def _resolve_concurrent_tool_timeout() -> float | None:
    raw = os.getenv("OPENCODON_CONCURRENT_TOOL_TIMEOUT_S", "").strip()
    if not raw:
    ...
    try:
        ...
        logger.warning(
            "invalid OPENCODON_CONCURRENT_TOOL_TIMEOUT_S=%r; using %.0fs",
            raw,
