...
When a provider returns a non-OK status on a *streaming* request, opencodon reads
...
streams"), generalized to cover opencodon's three streaming error-body sites
