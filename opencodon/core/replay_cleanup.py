...
from opencodon.core.tool_result_classification import tool_may_have_side_effect
...
def strip_dangling_tool_call_tail(
    ...
    ``systemctl restart``, ``kill``, ``opencodon gateway restart``), the process
    ...
    if any(
        ...
        for call in tool_calls:
            ...
            content = (
                "[Orphan recovery: this tool may have executed before opencodon stopped; "
