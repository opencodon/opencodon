...
from opencodon.core.lsp import eventlog
from opencodon.core.lsp.client import (
    DIAGNOSTICS_DOCUMENT_WAIT,
    LSPClient,
)
from opencodon.core.lsp.servers import (
    ServerContext,
    find_server_for_file,
    language_id_for,
)
from opencodon.core.lsp.workspace import (
    clear_cache,
    resolve_workspace_for_file,
)

logger = logging.getLogger("opencodon.core.lsp.manager")
...
class LSPService:
    ...
    def create_from_config(cls) -> Optional["LSPService"]:
        """Build a service from ``opencodon_cli.config`` settings.
        ...
        if delta:
            ...
            if baseline:
                if line_shift is not None:
                    ...
                    from opencodon.core.lsp.range_shift import shift_baseline
