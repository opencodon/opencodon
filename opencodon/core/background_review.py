...
from opencodon.core.thread_scoped_output import thread_scoped_silence
...
def _resolve_review_runtime(agent: Any) -> Dict[str, Any]:
    ...
    ``routed`` is False — the fork uses the main model and the warm cache, exactly as before. When
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("OPENCODON_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
