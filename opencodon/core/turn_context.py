...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``opencodon logs``.
    ...
    try:
        from opencodon.core.auxiliary_client import set_runtime_main
        set_runtime_main(
    ...
    from opencodon.core.agent_runtime_helpers import note_turn_start
    ...
    if reaction_callback is not None:
        try:
            from opencodon.core.reactions import detect_reaction
