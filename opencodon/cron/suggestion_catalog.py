...
These are the built-in automations opencodon can offer a new user out of the box —
    ...
    CatalogEntry(
        ...
        job_spec={
            "prompt": (
                ...
                "urgency classifier (run `python3 -m opencodon.cron.scripts.classify_items "
                "--threshold 7 --criteria ...` from the opencodon install — "
...
def seed_catalog_suggestions(
    *,
    ...
    """
    if add_fn is None:
        from opencodon.cron.suggestions import add_suggestion as add_fn  # type: ignore[assignment]
