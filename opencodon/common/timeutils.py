"""
Timezone-aware clock for opencodon.
...
Invalid timezone values log a warning and fall back safely — opencodon never
...
from opencodon.common.constants import get_config_path
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — opencodon requires 3.9+)
