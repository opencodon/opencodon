...
try:
    from opencodon_cli.pt_input_extras import (
...
from opencodon_cli.banner import _format_context_length, format_banner_version_label
...
load_hermes_dotenv(opencodon_home=_opencodon_home, project_env=_project_env)
...
def load_cli_config() -> Dict[str, Any]:
    ...
    If OPENCODON_IGNORE_USER_CONFIG=1 is set (via ``hermes chat --ignore-user-config``),
...
try:
    from opencodon_cli.skin_engine import init_skin_from_config
...
from opencodon_cli.banner import build_welcome_banner
from opencodon_cli.commands import SlashCommandCompleter, SlashCommandAutoSuggest
...
def _resolve_worktree_base(repo_root: str) -> tuple:
    ...
    (the ``~/.opencodon/opencodon`` clone is updated only by ``hermes update``,
...
def _install_skin_light_mode_hook() -> None:
    ...
    try:
        from opencodon_cli.skin_engine import SkinConfig  # type: ignore[import]
    except Exception:
        return
...
def _strip_leaked_bracketed_paste_wrappers(text: str) -> str:
    from opencodon_cli.input_sanitize import strip_leaked_bracketed_paste_wrappers
...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin):
    ...
    def __init__(
        ...
        if self.model == _DEFAULT_CONFIG_MODEL:
            ...
            if "localhost" in _base_url or "127.0.0.1" in _base_url:
                from opencodon_cli.runtime_provider import _auto_detect_local_model
        ...
        # by `hermes chat --ignore-rules` in opencodon_cli/main.py. When true we
        ...
        # it's shared across all Hermes processes for this OPENCODON_HOME.
    ...
    def _recover_terminal_after_interrupt(self) -> None:
        ...
        """
        try:
            from opencodon_cli.curses_ui import flush_stdin
            flush_stdin()
        except Exception:
            pass
    ...
    def _get_status_bar_snapshot(self) -> Dict[str, Any]:
        ...
        if model_short == model_name:
            ...
            from opencodon_cli.model_switch import format_model_for_display
    ...
    def set_voice_record_key_cache(self, raw_key: object) -> None:
        ...
        """
        try:
            from opencodon_cli.voice import format_voice_record_key_for_status
    ...
    def _normalize_model_for_provider(self, resolved_provider: str) -> bool:
        ...
        if resolved_provider == "copilot":
            try:
                from opencodon_cli.models import copilot_model_api_mode, normalize_copilot_model_id
        ...
        if resolved_provider in {"opencode-zen", "opencode-go"}:
            try:
                from opencodon_cli.models import normalize_opencode_model_id, opencode_model_api_mode
    ...
    def show_banner(self):
        ...
        from opencodon_cli.model_switch import is_nous_hermes_non_agentic
    ...
    def _try_attach_clipboard_image(self) -> bool:
        ...
        """
        from opencodon_cli.clipboard import save_clipboard_image
    ...
    def show_help(self):
        ...
        try:
            from opencodon_cli.skin_engine import get_active_help_header
    ...
    def _list_recent_sessions(self, limit: int = 10) -> list[dict[str, Any]]:
        ...
        if not self._session_db:
            return []
        try:
            from opencodon_cli.session_listing import query_session_listing
    ...
    def _show_recent_sessions(self, *, reason: str = "history", limit: int = 10) -> bool:
        ...
        from opencodon_cli.main import _relative_time
    ...
    def new_session(self, silent=False, title=None):
        ...
        if _config_model and _config_model != getattr(self, "model", None):
            ...
            try:
                from opencodon_cli.model_switch import switch_model as _switch_model
    ...
    def _apply_model_switch_result(
        ...
        try:
            from opencodon_cli.model_switch import resolve_display_context_length
    ...
    def _show_gateway_status(self):
        ...
        try:
            ...
            print()
            print(f"  Configuration file: {display_opencodon_home()}/config.yaml")
            print()
            ...
            print(f"    2. Or configure settings in {display_opencodon_home()}/config.yaml")
            print()
    ...
    def process_command(self, command: str) -> bool:
        ...
        from opencodon_cli.commands import resolve_command as _resolve_cmd
        ...
        if canonical in {"quit", "exit"}:
            ...
            from opencodon_cli.main import _print_version_info
            ...
            # Check for skill slash commands (/gif-search, /axolotl, etc.)
                ...
                from opencodon_cli.commands import COMMANDS
    ...
    def _manual_compress(self, cmd_original: str = ""):
        ...
        * ``/compress here [N]`` — boundary-aware compression. Summarize
        ...
        from opencodon_cli.partial_compress import (
                ...
                try:
                    if (
                        ...
                        if not is_seen(CLI_CONFIG, TOOL_PROGRESS_FLAG):
                            ...
                            mark_seen(_opencodon_home / "config.yaml", TOOL_PROGRESS_FLAG)
    ...
    def _print_exit_summary(self, clear_screen: bool = True):
        ...
        if msg_count > 0:
            ...
            try:
                from opencodon_cli.skin_engine import get_active_goodbye
    ...
    def _get_tui_prompt_symbols(self) -> tuple[str, str]:
        ...
        """
        try:
            from opencodon_cli.skin_engine import get_active_prompt_symbol
    ...
    def _build_tui_style_dict(self) -> dict[str, str]:
        ...
        try:
            from opencodon_cli.skin_engine import get_prompt_toolkit_style_overrides
    ...
    def run(self):
        ...
        try:
            from opencodon_cli.model_switch import prewarm_picker_cache_async
        ...
        def handle_enter(event):
            ...
            if self._model_picker_state:
                try:
                    ...
                    from opencodon_cli.model_switch import resolve_persist_behavior
