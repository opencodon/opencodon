...
```bash
python3 -m pyfiglet "OPENCODON" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=OPENCODON&font=Slant" | boxes -d stone
```
