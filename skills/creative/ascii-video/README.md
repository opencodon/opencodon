...
Built for [opencodon](https://github.com/opencodon/opencodon). Usable in any coding agent. Canonical source lives here; synced to [`opencodon/opencodon/skills/creative/ascii-video`](https://github.com/opencodon/opencodon/tree/main/skills/creative/ascii-video) via PR.
