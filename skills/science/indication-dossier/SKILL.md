...
description: "Structured indication dossiers: epidemiology, biology, standard of care, regulatory precedent."
version: 1.0.0
license: Apache-2.0
platforms: [linux, macos, windows]
metadata:
  opencodon:
    tags: [science, clinical, pharma, research]
    category: science
  provenance:
    ...
    modifications: "Retargeted to opencodon's literature toolset; donor connector references removed."
