...
description: "Verified literature review with source grounding and anti-fabrication checks."
version: 1.0.0
license: Apache-2.0
platforms: [linux, macos, windows]
metadata:
  opencodon:
    tags: [science, research, literature, citations]
    category: science
  provenance:
    ...
    modifications: "Retargeted to opencodon's literature toolset (OpenAlex/Crossref/PubMed tools) in place of the donor's connectors."
  third_party:
