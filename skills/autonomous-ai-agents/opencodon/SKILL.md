...
authoritative list or see the [live slash commands reference](https://github.com/opencodon/opencodon/tree/main/docs).
The registry of record is `opencodon_cli/commands.py` — every consumer
...
Full config reference: https://github.com/opencodon/opencodon/tree/main/docs
...
Full provider docs: https://github.com/opencodon/opencodon/tree/main/docs
...
User docs: https://github.com/opencodon/opencodon/tree/main/docs
...
For occasional contributors and PR authors. Full developer docs: https://github.com/opencodon/opencodon/tree/main/docs
...
1. Add `CommandDef` to `COMMAND_REGISTRY` in `opencodon_cli/commands.py`
...
- POSIX file modes (0o600, etc.) → `@pytest.mark.skipif(sys.platform.startswith("win"), reason="POSIX mode bits not enforced on Windows")` (see `tests/opencodon_cli/test_auth_toctou_file_modes.py`)
