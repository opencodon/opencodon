...
import type { ScrollBoxHandle } from '@opencodon/ink'
import { evictInkCaches } from '@opencodon/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.OPENCODON_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
