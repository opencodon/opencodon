"""Compat shim package: ``tui_gateway`` -> ``opencodon.frontends.tui`` (restructure Phase 3a).
...
from opencodon.frontends.tui import *  # noqa: F401,F403
import opencodon.frontends.tui as _real  # noqa: F401
