"""Compatibility shim — the real module is ``opencodon.toolsets``.
...
state stay coherent. New code must import from ``opencodon.toolsets``.
Deleted in Phase 5.
"""

import sys

import opencodon.toolsets as _real
