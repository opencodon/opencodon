...
class ComputeHost:
    ...
    def _run_real_turn(self, frame: dict[str, Any]) -> None:
        ...
        try:
            ...
            try:
                ...
                pass
            try:
                import opencodon_undo

                opencodon_undo.on_user_message_appended(session["session_key"])
            except Exception:
                pass
            try:
        ...
        try:
            ...
            if home_token is not None:
                try:
                    ...
                    pass
        try:
            from opencodon.frontends.tui.transport import bind_transport, reset_transport
    ...
    def _handle_control(self, frame: dict[str, Any]) -> None:
        ...
        try:
            from opencodon.frontends.tui import server
            from opencodon.frontends.tui.host_supervisor import MUTATOR_ROUTE_TABLE
