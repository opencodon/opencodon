"""Compatibility shim — the real module is ``opencodon.config.timeouts``.
...
New code must import from ``opencodon.config.timeouts``. Deleted in Phase 5.
"""

import sys

import opencodon.config.timeouts as _real
