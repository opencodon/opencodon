...
they were not: the CLI picker read :data:`opencodon.core.models.CANONICAL_PROVIDERS`
...
* ``auth_type`` / ``api_key_env_vars`` / ``base_url_env_var`` from
  :data:`opencodon.core.auth.PROVIDER_REGISTRY` (credential truth), and
...
# opencodon.core.auth.PROVIDER_REGISTRY and providers.base.ProviderProfile.
