...
def _model_flow_openrouter(config, current_model=""):
    ...
    from opencodon.frontends.cli.models import model_ids, get_pricing_for_provider
...
def _model_flow_moa(config, current_model=""):
    ...
    """
    from opencodon.frontends.cli.auth import _save_model_choice, deactivate_provider
    from opencodon.config import load_config, save_config
...
def _model_flow_qwen_oauth(_config, current_model=""):
    ...
    from opencodon.frontends.cli.models import fetch_api_models
...
def _model_flow_custom(config):
    ...
    from opencodon.frontends.cli.models import probe_api_models
...
def _model_flow_azure_foundry(config, current_model=""):
    ...
    * Manual entry when every probe fails (private endpoints, etc.).
    ...
    """
    from opencodon.frontends.cli.auth import _save_model_choice, deactivate_provider  # noqa: F401
    ...
    from opencodon.frontends.cli import azure_detect
...
def _model_flow_copilot(config, current_model=""):
    ...
    if not api_key:
        ...
        if choice == "1":
            try:
                from opencodon.frontends.cli.copilot_auth import copilot_device_code_login
            ...
            # Validate token type
            try:
                from opencodon.frontends.cli.copilot_auth import validate_copilot_token
...
def _model_flow_stepfun(config, current_model=""):
    ...
    from opencodon.frontends.cli.models import _PROVIDER_MODELS, fetch_api_models
...
def _select_zai_endpoint(current_base: str) -> str:
    ...
    from opencodon.frontends.cli.auth import ZAI_ENDPOINTS
...
def _model_flow_api_key_provider(config, provider_id, current_model=""):
    ...
    if provider_id == "lmstudio":
        ...
        from opencodon.frontends.cli.models import fetch_lmstudio_models
        ...
        from opencodon.frontends.cli.models import fetch_ollama_cloud_models
