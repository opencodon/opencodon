...
class CLICommandsMixin:
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from opencodon.frontends.cli.backup import (
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_opencodon_home()}/state-snapshots/):\n")
    ...
    def _handle_agents_command(self):
        ...
        from opencodon.frontends.cli.shell import _cprint
    ...
    def _handle_paste_command(self):
        ...
        """
        from opencodon.frontends.cli.shell import _DIM, _RST, _cprint, _termux_example_image_path
        ...
        from opencodon.frontends.cli.clipboard import has_clipboard_image
    ...
    def _handle_copy_command(self, cmd_original: str) -> None:
        ...
        from opencodon.frontends.cli.shell import _assistant_copy_text, _cprint
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        from opencodon.frontends.cli.shell import _DIM, _IMAGE_EXTENSIONS, _RST, _cprint, _resolve_attachment_path, _split_path_input, _termux_example_image_path
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        """
        from opencodon.frontends.cli.shell import _ACCENT, _DIM, _RST, _cprint
        import shlex
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in opencodon_cli/colors.py
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        from opencodon.frontends.cli.shell import _cprint, _sync_process_session_id
        ...
        if target.isdigit():
            ...
            from opencodon.frontends.cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_personality_command(self, cmd: str):
        ...
        from opencodon.frontends.cli.shell import save_config_value
    ...
    def _handle_cron_command(self, cmd: str):
        ...
        from opencodon.frontends.cli.shell import get_job
        import shlex
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from opencodon.frontends.cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from opencodon.frontends.cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to opencodon_cli.skills_hub."""
        from opencodon.frontends.cli.shell import ChatConsole
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from opencodon.frontends.cli.skills_hub import handle_skills_slash
    ...
    def _handle_background_command(self, cmd: str):
        ...
        """
        from opencodon.frontends.cli.shell import AIAgent, ChatConsole, _accent_hex, _cprint, _maybe_remap_for_light_mode, _render_final_assistant_content, set_approval_callback, set_secret_capture_callback, set_sudo_password_callback
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        from opencodon.frontends.cli.shell import _DIM, _RST, _cprint
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        from opencodon.frontends.cli.shell import _ACCENT, save_config_value
        try:
            from opencodon.frontends.cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_opencodon_home()}/skins/\n")
            return
    ...
    def _handle_footer_command(self, cmd_original: str) -> None:
        ...
        """
        from opencodon.frontends.cli.shell import _cprint, save_config_value
        from opencodon.config import load_config
    ...
    def _handle_reasoning_command(self, cmd: str):
        ...
        """
        from opencodon.frontends.cli.shell import CLI_CONFIG, _ACCENT, _DIM, _RST, _cprint, _parse_reasoning_config, save_config_value
        parts = cmd.strip().split(maxsplit=1)
    ...
    def _handle_busy_command(self, cmd: str):
        ...
        """
        from opencodon.frontends.cli.shell import _ACCENT, _DIM, _RST, _cprint, save_config_value
        parts = cmd.strip().split(maxsplit=1)
