"""Compatibility shim — the real module is ``opencodon.common.model_normalize``.
...
New code must import from ``opencodon.common.model_normalize``. Deleted in Phase 5.
"""

import sys

import opencodon.common.model_normalize as _real
