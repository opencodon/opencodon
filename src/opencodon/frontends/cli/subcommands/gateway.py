...
def build_gateway_parser(
    ...
    gateway_parser = subparsers.add_parser(
        ...
        description="Manage the messaging gateway (Telegram, Discord, WhatsApp, Slack, and more)",
    )
    ...
    gateway_enroll = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "Authenticates as your configured IdP identity (the connector derives the "
