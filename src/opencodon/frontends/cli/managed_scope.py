"""Compatibility shim — the real module is ``opencodon.config.managed_scope``.
...
New code must import from ``opencodon.config.managed_scope``. Deleted in Phase 5.
"""

import sys

import opencodon.config.managed_scope as _real
