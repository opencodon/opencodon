"""
Skills configuration for opencodon.
`opencodon skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.opencodon/config.yaml under:
...
from opencodon.frontends.cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `opencodon skills`."""
    from opencodon.frontends.cli.curses_ui import curses_checklist
