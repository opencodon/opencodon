...
def _codex_curated_models() -> list[str]:
    ...
    """
    from opencodon.frontends.cli.codex_models import DEFAULT_CODEX_MODELS, _add_forward_compat_models
...
def get_preferred_silent_default_model(provider: str = "openrouter") -> str:
    ...
    """
    try:
        from opencodon.frontends.cli.model_catalog import get_default_model_from_cache
...
def fetch_openrouter_models(
    ...
    *,
    ...
    try:
        from opencodon.frontends.cli.model_catalog import get_curated_openrouter_models
...
def list_available_providers() -> list[dict[str, str]]:
    ...
    for pid in provider_order:
        ...
        has_creds = False
        try:
            from opencodon.frontends.cli.auth import get_auth_status, has_usable_secret
            if pid == "custom":
...
def _resolve_copilot_catalog_api_key() -> str:
    ...
    """
    try:
        from opencodon.frontends.cli.auth import resolve_api_key_provider_credentials
