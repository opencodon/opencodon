...
def _resolve_identity_token() -> str:
    ...
    failure.
    """
    from opencodon.frontends.gateway.relay import _resolve_relay_identity_token
...
def cmd_gateway_enroll(args) -> None:
    ...
    from opencodon.core.auth import AuthError, resolve_nous_access_token
    ...
    #    save_env_value writes them to ~/.opencodon/.env (0600 dir) and never logs.
    to_write = {
    ...
    from opencodon.config import get_env_path
