...
class ShellModelSwitchMixin:
    def _normalize_model_for_provider(self, resolved_provider: str) -> bool:
        ...
        if resolved_provider == "copilot":
            try:
                from opencodon.core.providers.models import copilot_model_api_mode, normalize_copilot_model_id
        ...
        if resolved_provider in {"opencode-zen", "opencode-go"}:
            try:
                from opencodon.core.providers.models import normalize_opencode_model_id, opencode_model_api_mode
