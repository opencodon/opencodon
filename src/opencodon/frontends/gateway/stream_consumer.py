...
from opencodon.frontends.gateway.platforms.base import BasePlatformAdapter as _BasePlatformAdapter
from opencodon.frontends.gateway.platforms.base import _custom_unit_to_cp
from opencodon.frontends.gateway.platforms.base import MEDIA_TAG_CLEANUP_RE
from opencodon.frontends.gateway.config import (
    DEFAULT_STREAMING_EDIT_INTERVAL as _DEFAULT_STREAMING_EDIT_INTERVAL,
    DEFAULT_STREAMING_BUFFER_THRESHOLD as _DEFAULT_STREAMING_BUFFER_THRESHOLD,
    DEFAULT_STREAMING_CURSOR as _DEFAULT_STREAMING_CURSOR,
)
from opencodon.frontends.gateway.response_filters import (
...
class GatewayStreamConsumer:
    ...
    async def _send_commentary(self, text: str) -> bool:
        ...
        try:
            ...
            # multiple tool calls. upstream#10454
            if result.success:
    ...
    def _adapter_prefers_fresh_final(self, text: str) -> bool:
        ...
        currently renders richer markdown than opencodon' MarkdownV2 edit path.
