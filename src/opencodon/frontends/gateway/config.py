...
- Connected platforms (Telegram, Discord, WhatsApp, Slack, and more)
...
# dashboard's pre-write mutation validation (opencodon_cli/web_server.py) so
...
# Slack) do not need an entry here.
...
class GatewayConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        from opencodon.frontends.gateway.profile_routing import parse_profile_routes
...
def load_gateway_config() -> GatewayConfig:
    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            # through opencodon.config.load_config, so without this a managed
            ...
            try:
                ...
                from opencodon.frontends.gateway.platform_registry import platform_registry as _pr
            except Exception as e:
