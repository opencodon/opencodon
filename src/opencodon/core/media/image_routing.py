...
def _supports_vision_override(
    ...
    # (opencodon_cli/runtime_provider.py:_resolve_named_custom_runtime), so the
...
def _resolve_inference_base_url(
    ...
    try:
        from opencodon.core.auxiliary_client import _runtime_main_value
...
def _lookup_supports_vision(
    ...
    if _should_probe_ollama_vision(provider, base_url):
        try:
            from opencodon.core.providers.model_metadata import query_ollama_supports_vision
