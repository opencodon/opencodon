...
from opencodon.core.providers.anthropic_adapter import _is_oauth_token, resolve_anthropic_token
from opencodon.core.credentials.auth import AuthError, _read_codex_tokens, resolve_codex_runtime_credentials
...
def redeem_codex_reset_credit(
    *,
    ...
    if code == "reset":
        ...
        try:
            from opencodon.core.credentials.auth import clear_codex_pool_quota_cooldowns
