...
from opencodon.core.providers.models_dev import ModelInfo
...
class ExpensiveModelWarning:
    """Confirmation payload for models above opencodon' cost guardrail."""
...
def expensive_model_warning(
    ...
    *,
    ...
    if input_cost is None and output_cost is None and provider:
        try:
            from opencodon.core.providers.models_dev import get_model_info
    ...
    if input_cost is None and output_cost is None:
        try:
            from opencodon.core.providers.usage_pricing import get_pricing_entry
    ...
    lines = [
        ...
        "",
        f"{model} has known pricing above opencodon' safety threshold.",
