"""Vertex AI (Google Cloud) adapter for opencodon.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows opencodon to use Gemini models via Google Cloud with
...
from opencodon.core.credentials.secret_scope import get_secret as _get_secret, is_multiplex_active
