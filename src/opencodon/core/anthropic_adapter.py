...
def _build_anthropic_client_with_bearer_hook(
    ...
    *,
    ...
    from opencodon.core.azure_identity_adapter import build_bearer_http_client
...
def _resolve_anthropic_pool_token() -> Optional[str]:
    ...
    """
    try:
        from opencodon.core.credential_pool import AUTH_TYPE_OAUTH, load_pool
    except Exception:
        return None
...
def run_opencodon_oauth_login_pure() -> Optional[Dict[str, Any]]:
    ...
    try:
        from opencodon.frontends.cli.auth import _can_open_graphical_browser as _can_open_gui
    except Exception:
...
def _is_stream_unavailable_error(exc: Exception) -> bool:
    ...
    if "invokemodelwithresponsestream" in err_lower:
        from opencodon.core.bedrock_adapter import is_streaming_access_denied_error
