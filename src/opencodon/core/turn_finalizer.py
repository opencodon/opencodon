...
decomposition campaign (``~/.opencodon/plans/god-file-decomposition.md``, Phase 1
...
keep the exact logger name (``"opencodon.core.conversation_loop"``).
"""
...
def finalize_turn(
    ...
    *,
    ...
    """
    from opencodon.core.conversation_loop import logger
    ...
    try:
        ...
        if interrupted:
            from opencodon.core.message_sanitization import close_interrupted_tool_sequence
