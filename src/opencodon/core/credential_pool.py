...
from opencodon.core.credential_persistence import (
...
def _write_through_provider_state_to_global_root(
    ...
    ``opencodon.core.auth._write_through_xai_oauth_to_global_root`` (which covers
    ...
    def _sync_device_code_entry_to_auth_store(self, entry: PooledCredential) -> None:
        ...
        try:
            with _auth_store_lock():
                ...
                # opencodon.core.auth._save_xai_oauth_tokens (#43589); the pool
    ...
    def _refresh_entry_impl(
        ...
        try:
            if self.provider == "anthropic":
                from opencodon.core.anthropic_adapter import refresh_anthropic_oauth_pure
                ...
                if entry.source == "claude_code":
                    try:
                        from opencodon.core.anthropic_adapter import _write_claude_code_credentials
...
def _seed_from_singletons(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
        from opencodon.core.auth import is_source_suppressed as _is_suppressed
    except ImportError:
    ...
    if provider == "anthropic":
        ...
        from opencodon.core.anthropic_adapter import read_claude_code_credentials, read_opencodon_oauth_credentials
        ...
        try:
            from opencodon.core.auth import resolve_qwen_runtime_credentials
        ...
        try:
            from opencodon.core.auth import get_provider_auth_state
...
def _seed_from_env(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
        from opencodon.core.auth import is_source_suppressed as _is_source_suppressed
    except ImportError:
