...
from opencodon.core.transports.types import NormalizedResponse, ToolCall
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        from opencodon.core.run_agent import DEFAULT_AGENT_IDENTITY
        ...
        # through opencodon's agent loop.
        #
        ...
        # that would silently route around opencodon's web-provider config and
        ...
        # native search engine for xAI sessions instead of opencodon's
        # configured web provider (Tavily/etc.), and those results bypass
        # opencodon's tool-trace / citation plumbing (they arrive baked into the
