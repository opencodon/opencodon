...
from opencodon.core.context.context_engine import sanitize_memory_context
    ...
    *after* construction, so :func:`replay_compression_warning` re-sends
    ...
    try:
        ...
        if aux_context < threshold:
            ...
            from opencodon.core.context.context_compressor import ContextCompressor as _CC
