...
from opencodon.core.auth import AuthError, _read_codex_tokens, resolve_codex_runtime_credentials
...
def redeem_codex_reset_credit(
    *,
    ...
    if code == "reset":
        ...
        try:
            from opencodon.core.auth import clear_codex_pool_quota_cooldowns
