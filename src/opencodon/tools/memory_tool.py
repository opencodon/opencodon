...
# (OPENCODON_HOME env var changes) are always respected.  The old module-level
...
from opencodon.tools.threat_patterns import first_threat_message as _first_threat_message
