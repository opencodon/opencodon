...
Trust levels:
  - builtin:   Ships with opencodon. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.opencodon/\.env|\~/\.opencodon/\.env',
     "opencodon_env_access", "critical", "exfiltration",
     "directly references opencodon secrets file"),
    ...
    (r'\.opencodon/config\.yaml|\.opencodon/SOUL\.md',
     "opencodon_config_mod", "critical", "persistence",
     "references opencodon configuration files directly"),
...
# scan. `.skillignore` is the opencodon-native name; `.clawhubignore` is honored
