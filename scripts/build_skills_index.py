#!/usr/bin/env python3
"""Build the opencodon Skills Index — a centralized JSON catalog of all skills.
...
`opencodon skills search/install` can use it without hitting the GitHub API.
...
Output: build/skills-index.json (formerly the docs-site static API)
"""
...
OUTPUT_PATH = os.path.join(REPO_ROOT, "build", "skills-index.json")
INDEX_VERSION = 1
...
def main():
    print("Building opencodon Skills Index...", flush=True)
