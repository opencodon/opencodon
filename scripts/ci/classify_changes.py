...
_FRONTEND = ("apps/",)  # TS typecheck-matrix packages (covers apps/tui, apps/web, ...)
...
_MCP_CATALOG_FILES = {"opencodon_cli/mcp_catalog.py", "src/opencodon_cli/mcp_catalog.py", "src/opencodon/frontends/cli/mcp_catalog.py"}
