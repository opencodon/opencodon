...
VERSION_FILE = REPO_ROOT / "opencodon_cli" / "__init__.py"
...
LEGACY_AUTHOR_MAP = {
    ...
    "kavi@local.opencodon": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level OPENCODON_HOME for pid/lock/status identity files; #56986)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.opencodon/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "brett@personalfinancelab.com": "brett539",  # PR #49369 salvage (cap Telegram initialize() with asyncio.wait_for(OPENCODON_TELEGRAM_INIT_TIMEOUT, default 30s) per attempt so an unreachable fallback-IP connect chain can't block gateway startup indefinitely; add WARNING progress logs before DoH discovery and each connect attempt)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (OPENCODON_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (OPENCODON_HOME inject)
    ...
    "hex.opencodon@agentmail.to": "oseftg",
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level OPENCODON_HOME state files)
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/opencodon/opencodon",
