...
the get_anchored_view / get_messages_around primitives in opencodon_state.
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from opencodon_state import DEFAULT_DB_PATH
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches opencodon conversation history only. It is not evidence "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about opencodon conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another opencodon profile's database "
