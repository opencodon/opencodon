...
_RPC_DIR = os.environ.get("OPENCODON_RPC_DIR") or os.path.join(tempfile.gettempdir(), "hermes_rpc")
_seq = 0
...
def execute_code(
    ...
    try:
        ...
        # OPENCODON_TIMEZONE is an internal Hermes setting and must not leak
