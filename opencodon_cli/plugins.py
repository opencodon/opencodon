"""Compatibility shim — the real module is ``opencodon.plugins_runtime``.
...
New code must import from ``opencodon.plugins_runtime``. Deleted in Phase 5.
"""

import sys

import opencodon.plugins_runtime as _real
