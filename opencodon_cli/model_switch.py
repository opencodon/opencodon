...
def switch_model(
    ...
    if provider_changed or explicit_provider:
        ...
        if explicit_provider and user_providers:
            from opencodon_cli.providers import resolve_user_provider as _ruser
...
def list_authenticated_providers(
    ...
    *,
    ...
    def _record_builtin_endpoint(slug: str) -> None:
        ...
        try:
            from opencodon_cli.auth import PROVIDER_REGISTRY as _reg
        except Exception:
            return
        pcfg = _reg.get(slug)
        if not pcfg:
...
def _prepend_moa_picker_provider(providers: List[dict], current_provider: str = "") -> List[dict]:
    ...
    """
    try:
        from opencodon_cli.inventory import _moa_provider_row
...
def list_picker_providers(
    ...
    """
    from opencodon_cli.models import fetch_openrouter_models
