...
class CLICommandsMixin:
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from opencodon_cli.backup import (
    ...
    def _handle_paste_command(self):
        ...
        from opencodon_cli.clipboard import has_clipboard_image
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from opencodon_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from opencodon_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from opencodon_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from opencodon_cli.skills_hub import handle_skills_slash
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from opencodon_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from opencodon_cli.models import _is_anthropic_fast_model
