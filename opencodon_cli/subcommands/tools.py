"""``opencodon tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'opencodon tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # opencodon tools list [--platform cli]
    ...
    # opencodon tools disable <name...> [--platform cli]
    ...
    # opencodon tools enable <name...> [--platform cli]
    ...
    # opencodon tools post-setup <key>
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `opencodon tools` runs after you pick a provider that\n"
