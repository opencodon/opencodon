...
def _prompt(question: str, *, password: bool = False, default: str = "") -> str:
    from opencodon_cli.cli_output import prompt as _shared_prompt
...
def mcp_command(args):
    ...
    if action == "picker":
        from opencodon_cli.mcp_picker import run_picker
        run_picker()
        return
    if action == "catalog":
        from opencodon_cli.mcp_picker import show_catalog
        show_catalog()
        return
    if action == "install":
