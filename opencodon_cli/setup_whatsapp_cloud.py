...
Entry point: ``opencodon whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``opencodon_cli/main.py``).
...
opencodon gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures opencodon to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  opencodon needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the opencodon gateway in another terminal:")
    print("         opencodon gateway")
    print()
