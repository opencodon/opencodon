...
from opencodon_cli.cli_output import (  # noqa: E402 — late import block
...
def _xai_credentials_present() -> bool:
    ...
    """
    try:
        from opencodon_cli.auth import _read_xai_oauth_tokens
...
from opencodon_cli.platforms import PLATFORMS as _PLATFORMS_REGISTRY
...
def _run_post_setup(post_setup_key: str):
    ...
    if post_setup_key in {"agent_browser", "browserbase"}:
        ...
        try:
            from opencodon_cli.plugins_cmd import _get_enabled_set, _save_enabled_set
...
def _prompt_toolset_checklist(
    ...
    *,
    ...
    from opencodon_cli.curses_ui import curses_checklist
