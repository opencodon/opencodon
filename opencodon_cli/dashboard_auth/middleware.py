...
from opencodon_cli.dashboard_auth import list_session_providers
...
def _unauth_response(request: Request, *, reason: str) -> Response:
    ...
    """
    from opencodon_cli.dashboard_auth.prefix import prefix_from_request
...
def _auto_sso_response(request: Request) -> Response | None:
    ...
    from opencodon_cli.dashboard_auth.cookies import detect_https
    set_sso_attempt_cookie(
...
async def gated_auth_middleware(
    ...
    if session is None:
        ...
        from opencodon_cli.dashboard_auth.cookies import clear_session_cookies
        from opencodon_cli.dashboard_auth.prefix import prefix_from_request
