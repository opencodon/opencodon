...
def _run_and_exit_oneshot(
    ...
    *,
    ...
    try:
        from opencodon_cli.oneshot import run_oneshot
...
from opencodon_cli.subcommands._shared import add_accept_hooks_flag as _add_accept_hooks_flag
from opencodon_cli.subcommands.cron import build_cron_parser
from opencodon_cli.subcommands.gateway import build_gateway_parser
from opencodon_cli.subcommands.profile import build_profile_parser
from opencodon_cli.subcommands.model import build_model_parser
from opencodon_cli.subcommands.setup import build_setup_parser

from opencodon_cli.subcommands.whatsapp import build_whatsapp_parser
from opencodon_cli.subcommands.slack import build_slack_parser
from opencodon_cli.subcommands.login import build_login_parser
from opencodon_cli.subcommands.logout import build_logout_parser
from opencodon_cli.subcommands.auth import build_auth_parser
from opencodon_cli.subcommands.status import build_status_parser
from opencodon_cli.subcommands.webhook import build_webhook_parser
from opencodon_cli.subcommands.hooks import build_hooks_parser
from opencodon_cli.subcommands.doctor import build_doctor_parser
from opencodon_cli.subcommands.security import build_security_parser
from opencodon_cli.subcommands.dump import build_dump_parser
from opencodon_cli.subcommands.debug import build_debug_parser
from opencodon_cli.subcommands.backup import build_backup_parser
from opencodon_cli.subcommands.import_cmd import build_import_cmd_parser
from opencodon_cli.subcommands.config import build_config_parser
from opencodon_cli.subcommands.skin import build_skin_parser
from opencodon_cli.subcommands.console import build_console_parser
from opencodon_cli.subcommands.version import build_version_parser
from opencodon_cli.subcommands.update import build_update_parser
from opencodon_cli.subcommands.uninstall import build_uninstall_parser
from opencodon_cli.subcommands.dashboard import build_dashboard_parser
from opencodon_cli.subcommands.gui import build_gui_parser
from opencodon_cli.subcommands.logs import build_logs_parser
from opencodon_cli.subcommands.prompt_size import build_prompt_size_parser
...
from opencodon_cli.subcommands.tools import build_tools_parser
from opencodon_cli.subcommands.insights import build_insights_parser
from opencodon_cli.subcommands.skills import build_skills_parser
...
def _normalize_tui_toolsets(toolsets: object) -> list[str]:
    ...
    try:
        from opencodon_cli.oneshot import _normalize_toolsets
...
def _launch_tui(
    ...
    if code == 42:
        from opencodon_cli.relaunch import relaunch
...
def cmd_gateway(args):
    ...
    from opencodon_cli.gateway import gateway_command
...
def cmd_proxy(args):
    ...
    from opencodon_cli.proxy.cli import cmd_proxy as _cmd_proxy
...
def cmd_whatsapp_cloud(args):
    ...
    from opencodon_cli.setup_whatsapp_cloud import run_whatsapp_cloud_setup
...
def cmd_model(args):
    ...
    if getattr(args, "refresh", False):
        try:
            from opencodon_cli.models import clear_provider_models_cache
...
def select_provider_and_model(args=None):
    ...
    from opencodon_cli.providers import resolve_provider_full
...
def _aux_flow_provider_model(
    ...
    from opencodon_cli.auth import _prompt_model_selection
    from opencodon_cli.models import get_pricing_for_provider
...
def _prompt_provider_choice(choices, *, default=0, title="Select provider:"):
    ...
    """
    try:
        from opencodon_cli.setup import _curses_prompt_choice
...
def _remove_custom_provider(config):
    ...
    try:
        from opencodon_cli.curses_ui import curses_radiolist
...
def cmd_login(args):
    ...
    from opencodon_cli.auth import login_command
...
def cmd_logout(args):
    ...
    from opencodon_cli.auth import logout_command
...
def cmd_auth(args):
    ...
    from opencodon_cli.auth_commands import auth_command
...
def cmd_status(args):
    ...
    from opencodon_cli.status import show_status
...
def cmd_webhook(args):
    ...
    from opencodon_cli.webhook import webhook_command
...
def cmd_slack(args):
    ...
    if sub == "manifest":
        from opencodon_cli.slack_cli import slack_manifest_command
...
def cmd_hooks(args):
    ...
    from opencodon_cli.hooks import hooks_command
...
def cmd_doctor(args):
    ...
    from opencodon_cli.doctor import run_doctor
...
def cmd_security(args):
    ...
    if sub in ("audit", None):
        from opencodon_cli.security_audit import cmd_security_audit
...
def cmd_dump(args):
    ...
    from opencodon_cli.dump import run_dump
...
def cmd_debug(args):
    ...
    from opencodon_cli.debug import run_debug
...
def cmd_skin(args):
    ...
    from opencodon_cli.skin_cmd import skin_command
...
def cmd_backup(args):
    ...
    if getattr(args, "quick", False):
        from opencodon_cli.backup import run_quick_backup
...
def cmd_uninstall(args):
    ...
    if getattr(args, "gui_summary", False):
        from opencodon_cli.gui_uninstall import gui_install_summary
    ...
    if getattr(args, "gui", False):
        ...
        from opencodon_cli.uninstall import run_gui_uninstall
    ...
    from opencodon_cli.uninstall import run_uninstall
...
def _update_via_zip(args):
    ...
    from opencodon_cli.managed_uv import ensure_uv, update_managed_uv
    ...
    try:
        from opencodon_cli.model_catalog import seed_cache_from_checkout
...
def _recover_from_interrupted_install() -> None:
    ...
    try:
        ...
        try:
            from opencodon_cli.managed_uv import ensure_uv
...
def _install_psutil_android_compat(
    ...
    *,
    ...
    from opencodon_cli.psutil_android import PSUTIL_URL, prepare_patched_psutil_sdist
...
def _ensure_uv_for_termux(pip_cmd: list[str]) -> str | None:
    ...
    """
    from opencodon_cli.managed_uv import resolve_uv
...
def _run_pre_update_backup(args) -> Optional[str]:
    ...
    snapshot_id = None
    try:
        from opencodon_cli.backup import create_quick_snapshot
    ...
    *, exclude_pids: set[int] | None = None
    ...
    for proc in proc_iter:
        ...
        if not is_holder and venv_prefix in cmdline_low:
            is_holder = True
        if not is_holder and "opencodon_cli.main" in cmdline_low:
...
def _pause_windows_gateways_for_update() -> dict | None:
    ...
    if not running_pids:
        ...
        try:
            from opencodon_cli import gateway_windows
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        try:
            from opencodon_cli.profiles import backfill_profile_envs
        ...
        # it and warn loudly.
        try:
            from opencodon_cli.backup import restore_cron_jobs_if_emptied
        ...
        try:
            ...
            if (
                ...
                from opencodon_cli.tools_config import install_cua_driver
...
def cmd_profile(args):
    ...
    if action == "list":
        ...
        from opencodon_cli import profile_describer as _pd
        ...
        from opencodon_cli.profiles import profile_exists, validate_alias_name
        ...
        from opencodon_cli.profiles import rename_profile
        ...
        from opencodon_cli.profiles import export_profile
        ...
        from opencodon_cli.profiles import import_profile
        ...
        import tempfile
        from opencodon_cli.profile_distribution import (
            plan_install,
        ...
        from opencodon_cli.profiles import get_profile_dir, normalize_profile_name
        ...
        from opencodon_cli.profile_distribution import describe_distribution, DistributionError
...
def _render_distribution_plan(plan) -> None:
    ...
    from opencodon_cli.profile_distribution import MANIFEST_FILENAME
    mf = plan.manifest
...
def _maybe_setup_dashboard_auth_interactively(args) -> None:
    ...
    try:
        from opencodon_cli.web_server import should_require_auth
...
def _read_ssh_session_token_file(path: str) -> str:
    ...
    if sys.platform == "win32":
        from opencodon_cli.windows_ssh_runtime import read_token
...
def cmd_dashboard(args):
    ...
    from opencodon_cli.web_server import start_server
...
def cmd_gateway_enroll(args):
    ...
    from opencodon_cli.gateway_enroll import cmd_gateway_enroll as _impl
...
def cmd_completion(args, parser=None):
    ...
    from opencodon_cli.completion import generate_bash, generate_zsh, generate_fish
...
def cmd_prompt_size(args):
    ...
    from opencodon_cli.prompt_size import cmd_prompt_size as _impl
...
def cmd_logs(args):
    ...
    from opencodon_cli.logs import tail_log, list_logs
...
def cmd_console(args):
    ...
    from opencodon_cli.console_engine import run_console_repl
...
def _build_provider_choices() -> list[str]:
    ...
    try:
        from opencodon_cli.models import CANONICAL_PROVIDERS as _cp
...
def cmd_tools(args):
    ...
    if action in {"list", "disable", "enable"}:
        from opencodon_cli.tools_config import tools_disable_enable_command

        tools_disable_enable_command(args)
    elif action == "post-setup":
        from opencodon_cli.tools_config import run_post_setup_command

        sys.exit(run_post_setup_command(args))
    else:
        _require_tty("tools")
        from opencodon_cli.tools_config import tools_command
...
def cmd_skills(args):
    ...
    if getattr(args, "skills_action", None) == "config":
        ...
        from opencodon_cli.skills_config import skills_command as skills_config_command

        skills_config_command(args)
    else:
        from opencodon_cli.skills_hub import skills_command

        skills_command(args)


def cmd_pairing(args):
    from opencodon_cli.pairing import pairing_command

    pairing_command(args)


def cmd_plugins(args):
    from opencodon_cli.plugins_cmd import plugins_command
...
def main():
    ...
    try:
        from opencodon_cli.stdio import configure_windows_stdio
    ...
    from opencodon_cli.moa_cmd import cmd_moa
    ...
    # =========================================================================
    from opencodon_cli.fallback_cmd import cmd_fallback
    ...
    from opencodon_cli import secrets_cli as _secrets_cli
    from opencodon_cli import onepassword_secrets_cli as _op_secrets_cli
    ...
    # =========================================================================
    from opencodon_cli.send_cmd import register_send_subparser
    ...
    # =========================================================================
    from opencodon_cli.projects_cmd import build_parser as _build_project_parser
    ...
    from opencodon_cli.checkpoints import register_cli as _register_checkpoints_cli
    ...
    from opencodon_cli.bundles import register_cli as _bundles_register, bundles_command
    ...
    try:
        from opencodon_cli.curator import register_cli as _register_curator_cli
    ...
    def cmd_computer_use(args):
        ...
        if action == "status":
            ...
            if path:
                version = ""
                try:
                    from opencodon_cli.tools_config import _cua_driver_env
    ...
    def cmd_sessions(args):
        ...
        if action == "list":
            ...
            from opencodon_cli.session_filters import (
                build_prune_filters,
                describe_filters,
            )
            ...
            def _redact(data):
                if not args.redact or data is None:
                    return data
                from opencodon_cli.session_export_md import redact_session_data
            ...
            if getattr(args, "only", None):
                if args.format not in ("jsonl", "md"):
                    ...
                    return
                from opencodon_cli.session_export import (
                    export_record_count,
            ...
            if args.format == "html":
                if not args.output or args.output == "-":
                    ...
                    return
                from opencodon_cli.session_export_html import (
            ...
            # Markdown / QMD export
            from opencodon_cli.session_export_md import (
