...
def _current_profile_cli_args() -> list[str]:
    ...
    from opencodon_cli.gateway import _profile_arg
...
def _launch_elevated_gateway_command(command: str, extra_args: list[str] | None = None) -> bool:
    ...
    """
    _assert_windows()
    args = ["-m", "opencodon_cli.main", *_current_profile_cli_args(), "gateway", command]
    if extra_args:
...
def get_task_name() -> str:
    ...
    from opencodon_cli.gateway import _profile_suffix
...
def _build_gateway_cmd_script(
    ...
    prog_args = [pythonw_path, "-m", "opencodon_cli.main"]
    if profile_arg:
...
def _prompt_install_choices(
    ...
    from opencodon_cli.setup import prompt_yes_no
...
def _install_startup_fallback(script_path: Path, start_now: bool, detail: str) -> None:
    ...
    from opencodon_cli.gateway import find_gateway_pids, _profile_arg
