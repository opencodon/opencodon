"""Default SOUL.md template seeded into OPENCODON_HOME on first run."""

DEFAULT_SOUL_MD = (
    "You are opencodon, an intelligent AI assistant. "
...
_LEGACY_TEMPLATE_SOULS = (
    (
        ...
        "Edit this to customize how opencodon communicates with you.\n"
        "\n"
        "Examples:\n"
