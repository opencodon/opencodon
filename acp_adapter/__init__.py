"""Compat shim package: ``acp_adapter`` -> ``opencodon.frontends.acp`` (restructure Phase 3a).
...
from opencodon.frontends.acp import *  # noqa: F401,F403
import opencodon.frontends.acp as _real  # noqa: F401
