...
# When the user hasn't picked a reasoning effort, opencodon passes
...
# ON at this effort — matching the "medium (default)" that opencodon' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map opencodon' effort vocabulary onto Solar's accepted set. xhigh/max/
