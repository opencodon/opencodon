...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [Nous Research Discord](https://github.com/opencodon/opencodon/discussions). Users can install it with `hermes skills install`.
...
- Implement the relevant ABC and use the existing plugin discovery path (`~/.opencodon/plugins/`, project `.opencodon/plugins/`, or a pip entry point) — see [Build a Hermes Plugin](https://github.com/opencodon/opencodon/tree/main/docs)
