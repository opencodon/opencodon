...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in [GitHub Discussions](https://github.com/opencodon/opencodon/discussions). Users can install it with `opencodon skills install`.
...
- Promote it in [GitHub Discussions](https://github.com/opencodon/opencodon/discussions) so users can find and install it
