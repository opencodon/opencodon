...
def test_bedrock_stream_interrupt_not_swallowed_post_worker():
    ...
    with patch("opencodon.core.bedrock_adapter._get_bedrock_runtime_client", return_value=fake_client), \
         patch("opencodon.core.bedrock_adapter.stream_converse_with_callbacks", side_effect=_fake_stream), \
         patch("opencodon.core.bedrock_adapter.normalize_converse_response", side_effect=lambda r: r), \
         patch("opencodon.core.bedrock_adapter.is_stale_connection_error", return_value=False), \
         patch("opencodon.core.bedrock_adapter.is_streaming_access_denied_error", return_value=False), \
         patch("opencodon.core.bedrock_adapter.invalidate_runtime_client", lambda *a, **k: None):
...
def test_bedrock_stream_returns_normally_when_not_interrupted():
    ...
    with patch("opencodon.core.bedrock_adapter._get_bedrock_runtime_client", return_value=fake_client), \
         patch("opencodon.core.bedrock_adapter.stream_converse_with_callbacks", return_value=resp), \
         patch("opencodon.core.bedrock_adapter.normalize_converse_response", side_effect=lambda r: r), \
         patch("opencodon.core.bedrock_adapter.is_stale_connection_error", return_value=False), \
         patch("opencodon.core.bedrock_adapter.is_streaming_access_denied_error", return_value=False), \
         patch("opencodon.core.bedrock_adapter.invalidate_runtime_client", lambda *a, **k: None):
