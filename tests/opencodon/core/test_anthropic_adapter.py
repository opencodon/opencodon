...
class TestBuildAnthropicClient:
    ...
    def test_palantir_bearer_auth_matches_hostname_not_substring(self):
        ...
        from opencodon.core.anthropic_adapter import _requires_bearer_auth
...
class TestReadClaudeCodeCredentials:
    ...
    def no_keychain(self, monkeypatch):
        monkeypatch.setattr(
            "opencodon.core.anthropic_adapter._read_claude_code_credentials_from_keychain",
            lambda: None,
        )
    ...
    def test_reads_valid_credentials(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("opencodon.core.anthropic_adapter.Path.home", lambda: tmp_path)
...
class TestResolveAnthropicToken:
    ...
    def test_falls_back_to_anthropic_credential_pool_oauth(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("opencodon.core.credential_pool.load_pool", lambda provider: pool)
    ...
    def test_pool_is_not_consulted_when_env_token_present(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("opencodon.core.credential_pool.load_pool", _tracking_load_pool)
...
class TestRefreshOauthToken:
    def test_returns_none_without_refresh_token(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "opencodon.core.anthropic_adapter.read_claude_code_credentials", lambda: None
        )
...
class TestResolveWithRefresh:
    def test_auto_refresh_on_expired_creds(self, monkeypatch, tmp_path):
        ...
        with patch("opencodon.core.anthropic_adapter._refresh_oauth_token", return_value="refreshed-token"):
...
class TestBuildAnthropicKwargs:
    ...
    def test_supports_fast_mode_predicate(self):
        ...
        """
        from opencodon.core.anthropic_adapter import _supports_fast_mode
