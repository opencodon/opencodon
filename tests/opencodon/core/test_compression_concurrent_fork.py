...
def test_compression_activity_heartbeat_nonfinite_interval_falls_back(tmp_path: Path) -> None:
    ...
    from opencodon.core.conversation_compression import _CompressionActivityHeartbeat
...
def test_restored_anchor_never_creates_consecutive_user_roles() -> None:
    ...
    """
    from opencodon.core.conversation_compression import _insert_real_user_anchor
...
def test_lease_refresher_start_exception_releases_lock(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "opencodon.core.conversation_compression._CompressionLockLeaseRefresher",
...
def test_lease_refresher_survives_single_transient_failure() -> None:
    ...
    """
    from opencodon.core.conversation_compression import _CompressionLockLeaseRefresher
