...
class TestGetToolEmoji:
    ...
    def test_returns_registry_emoji_when_no_skin(self):
        ...
        with mock_patch("opencodon.core.display._get_skin", return_value=None), \
             mock_patch("opencodon.core.display.registry", mock_registry, create=True):
...
class TestSkinConfigToolEmojis:
    ...
    def test_build_skin_config_includes_tool_emojis(self):
        from opencodon.frontends.cli.skin_engine import _build_skin_config
        data = {
            "name": "custom",
