...
def http_server(tmp_path, monkeypatch):
    ...
    for mod in list(sys.modules):
        if mod.startswith("opencodon_constants") or mod.startswith("opencodon.core.image_gen_provider"):
...
class TestSaveUrlImage:
    def test_writes_real_bytes_to_opencodon_home_cache(self, http_server):
        base, _ = http_server
        from opencodon.core.image_gen_provider import save_url_image
    ...
    def test_oversize_raises_and_cleans_up(self, http_server, tmp_path):
        ...
        base, _ = http_server
        from opencodon.core.image_gen_provider import save_url_image, _images_cache_dir
