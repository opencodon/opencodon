...
Note: Tests that import ``opencodon.core.auth`` or ``opencodon.core.runtime_provider``
...
class TestResolveProvider:
    ...
    def test_auto_detect_with_aws_credentials(self, monkeypatch):
        ...
        with patch("opencodon.core.auth._load_auth_store", return_value={}):
...
class TestRuntimeProvider:
    ...
    def test_bedrock_runtime_resolution(self, monkeypatch):
        ...
        with patch("opencodon.core.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("opencodon.core.runtime_provider._get_model_config", return_value={"provider": "bedrock"}):
    ...
    def test_bedrock_runtime_no_credentials_raises_on_auto_detect(self, monkeypatch):
        ...
        with patch("opencodon.core.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("opencodon.core.runtime_provider._get_model_config", return_value={"provider": "bedrock"}), \
             patch("opencodon.core.runtime_provider.resolve_requested_provider", return_value="auto"), \
