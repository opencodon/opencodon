"""Tests for `_can_open_graphical_browser()` in opencodon.core.auth.
...
from opencodon.core.auth import _can_open_graphical_browser
...
def _force_platform_linux(monkeypatch):
    monkeypatch.setattr("opencodon.core.auth.sys.platform", "linux")
...
def test_non_linux_with_gui_allows(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.auth.sys.platform", "darwin")
