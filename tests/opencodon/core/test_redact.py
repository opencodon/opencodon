...
from opencodon.core.redact import redact_cdp_url, redact_sensitive_text, RedactingFormatter


@pytest.fixture(autouse=True)
def _ensure_redaction_enabled(monkeypatch):
    """Ensure OPENCODON_REDACT_SECRETS is not disabled by prior test imports."""
...
class TestTerminalOutputRedaction:
    ...
    def test_is_env_dump_command_detection(self):
        from opencodon.core.redact import is_env_dump_command
