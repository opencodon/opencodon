...
def _stub_runtime_main():
    with patch("opencodon.core.auxiliary_client.set_runtime_main", lambda *a, **k: None):
        yield
...
@pytest.fixture()
def wire_env():
    """Mock provider + isolated OPENCODON_HOME + a shared SessionDB.
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["OPENCODON_HOME"] = prev_home
...
from opencodon.core.turn_context import reanchor_current_turn_user_idx
...
class TestStaleConfirmationRedactionDropsSidecar:
    def test_redaction_pops_api_content(self):
        ...
        redacted."""
        from opencodon.core.replay_cleanup import strip_stale_dangerous_confirmations
