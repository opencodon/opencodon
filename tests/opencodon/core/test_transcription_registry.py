...
class TestRegistration:
    ...
    def test_rejects_builtin_shadow_with_warning(self, builtin, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="opencodon.core.transcription_registry"):
            transcription_registry.register_provider(p)
    ...
    def test_reregistration_overwrites(self, caplog):
        ...
        with caplog.at_level(logging.DEBUG, logger="opencodon.core.transcription_registry"):
