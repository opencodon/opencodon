...
class TestPluginContextEngineSlot:
    ...
    def test_register_engine(self):
        from opencodon.plugins_runtime import PluginManager, PluginContext, PluginManifest
        mgr = PluginManager()
    ...
    def test_get_plugin_context_engine(self):
        from opencodon.plugins_runtime import PluginManager, get_plugin_context_engine
...
class TestInitAgentDoesNotMutatePluginSingleton:
    ...
    def test_agent_init_source_deepcopies_singleton_not_aliases(self):
        ...
        import inspect
        import re
        import opencodon.core.agent_init as _ai
