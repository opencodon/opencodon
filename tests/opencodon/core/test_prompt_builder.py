...
from opencodon.core.prompt_builder import (
...
class TestParseSkillFile:
    ...
    def test_logs_parse_failures_and_returns_defaults(self, tmp_path, monkeypatch, caplog):
        ...
        with caplog.at_level(logging.DEBUG, logger="opencodon.core.prompt_builder"):
            is_compat, frontmatter, desc = _parse_skill_file(skill_file)
    ...
    def test_incompatible_platform_returns_false(self, tmp_path):
        ...
        with patch("opencodon.core.skill_utils.sys") as mock_sys:
...
class TestPromptBuilderImports:
    def test_module_import_does_not_eagerly_import_skills_tool(self, monkeypatch):
        ...
        monkeypatch.delitem(sys.modules, "opencodon.core.prompt_builder", raising=False)
        monkeypatch.setattr(builtins, "__import__", guarded_import)

        module = importlib.import_module("opencodon.core.prompt_builder")
...
class TestBuildSkillsSystemPrompt:
    ...
    def test_excludes_disabled_skills(self, monkeypatch, tmp_path):
        ...
        with patch(
            "opencodon.core.prompt_builder.get_disabled_skill_names",
...
class TestFindOpencodonMd:
    ...
    def test_no_git_root_checks_cwd_only(self, tmp_path):
        ...
        with patch("opencodon.core.prompt_builder._find_git_root", return_value=None):
    ...
    def test_walks_parents_inside_git_repo(self, tmp_path):
        ...
        with patch("opencodon.core.prompt_builder._find_git_root", return_value=tmp_path):
            assert _find_opencodon_md(sub) == tmp_path / ".opencodon.md"
...
class TestPromptBuilderConstants:
    ...
    def test_telegram_hint_encourages_rich_markdown(self):
        ...
        from opencodon.core.prompt_builder import TELEGRAM_RICH_MESSAGES_HINT
