...
@pytest.mark.parametrize("url,expected,label", [
    ...
    ("https://inference.example.com/v1", False, "Nous"),
    ("", False, "empty"),
    (None, False, "None"),
])
def test_endpoint_speaks_anthropic_messages(url, expected, label):
    from opencodon.core.auxiliary_client import _endpoint_speaks_anthropic_messages
...
def test_maybe_wrap_anthropic_rewraps_kimi_coding_url():
    ...
    from opencodon.core.auxiliary_client import _maybe_wrap_anthropic, AnthropicAuxiliaryClient
