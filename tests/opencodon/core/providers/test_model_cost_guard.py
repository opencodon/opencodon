...
from opencodon.core.providers.usage_pricing import PricingEntry
...
def test_warns_when_pricing_entry_output_price_exceeds_threshold(monkeypatch):
    monkeypatch.setattr("opencodon.core.providers.models_dev.get_model_info", lambda *_args, **_kwargs: None)
    monkeypatch.setattr(
        "opencodon.core.providers.usage_pricing.get_pricing_entry",
