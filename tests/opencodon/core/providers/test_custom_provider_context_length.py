...
class TestGetModelContextLengthHonorsOverride:
    """opencodon.core.providers.model_metadata.get_model_context_length must honor the
    ...
    def _mock_all_probes(self):
        ...
        from opencodon.core.providers import model_metadata as _mm
        return [
...
class TestContextProbeTiers:
    def test_256k_is_top_tier_and_default(self):
        ...
        from opencodon.core.providers.model_metadata import CONTEXT_PROBE_TIERS, DEFAULT_FALLBACK_CONTEXT
