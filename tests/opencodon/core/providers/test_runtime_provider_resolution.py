...
def test_minimax_oauth_runtime_returns_anthropic_messages_mode(monkeypatch):
    ...
    from opencodon.core.credentials.auth import MINIMAX_OAUTH_GLOBAL_INFERENCE
...
def test_minimax_oauth_runtime_uses_inference_base_url(monkeypatch):
    ...
    from opencodon.core.credentials.auth import MINIMAX_OAUTH_CN_INFERENCE
...
def _patch_bedrock(monkeypatch, config_default=""):
    ...
    """
    import opencodon.core.providers.bedrock_adapter as ba
