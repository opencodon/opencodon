...
from opencodon.core.providers.copilot_acp_client import _is_gh_copilot_deprecation_message
...
class TestGitHubModelsAzureUrl:
    ...
    def test_is_github_models_base_url_recognises_azure(self):
        from opencodon.core.providers.models import _is_github_models_base_url
