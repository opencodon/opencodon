"""Tests for opencodon.core.providers.models_dev — models.dev registry integration."""
...
class TestLookupModelsDevContext:
    @patch("opencodon.core.providers.models_dev.fetch_models_dev")
...
class TestFetchModelsDev:
    @patch("opencodon.core.providers.models_dev.requests.get")
    ...
    def test_force_refresh_skips_disk_cache(self, mock_get):
        ...
        disk-cache fast path. Used by ``opencodon config refresh`` and
...
class TestGetModelCapabilities:
    ...
    def test_vision_from_attachment_flag(self):
        ...
        with patch("opencodon.core.providers.models_dev.fetch_models_dev", return_value=CAPS_REGISTRY):
