...
def test_openrouter_models_api_pricing_is_converted_from_per_token_to_per_million(monkeypatch):
    monkeypatch.setattr(
        "opencodon.core.providers.usage_pricing.fetch_model_metadata",
        lambda: {
...
def test_custom_endpoint_models_api_pricing_is_supported(monkeypatch):
    monkeypatch.setattr(
        "opencodon.core.providers.usage_pricing.fetch_endpoint_model_metadata",
...
def test_deepseek_rows_all_carry_cache_read_pricing():
    ...
    from opencodon.core.providers.usage_pricing import _OFFICIAL_DOCS_PRICING
