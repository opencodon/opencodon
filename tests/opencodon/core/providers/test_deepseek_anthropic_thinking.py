...
blocks that opencodon synthesises from ``reasoning_content``.
...
class TestDeepSeekAnthropicPreservesThinking:
    ...
    def test_cache_control_stripped_from_thinking_block(self) -> None:
        ...
        upstreams that do check them, so opencodon strips them everywhere.
        """
        from opencodon.core.providers.anthropic_adapter import convert_messages_to_anthropic
    ...
    def test_openai_compat_deepseek_base_is_not_matched(self) -> None:
        ...
        """
        from opencodon.core.providers.anthropic_adapter import _is_deepseek_anthropic_endpoint
