...
from opencodon.core.providers.model_metadata import query_ollama_num_ctx, query_ollama_supports_vision
...
class TestQueryOllamaNumCtx:
    ...
    def test_returns_none_on_connection_error(self):
        ...
        with patch("opencodon.core.providers.model_metadata.detect_local_server_type", side_effect=Exception("timeout")):
