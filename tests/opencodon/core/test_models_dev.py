"""Tests for opencodon.core.models_dev — models.dev registry integration."""
...
class TestLookupModelsDevContext:
    @patch("opencodon.core.models_dev.fetch_models_dev")
...
class TestFetchModelsDev:
    @patch("opencodon.core.models_dev.requests.get")
...
class TestGetModelCapabilities:
    ...
    def test_vision_from_attachment_flag(self):
        ...
        with patch("opencodon.core.models_dev.fetch_models_dev", return_value=CAPS_REGISTRY):
