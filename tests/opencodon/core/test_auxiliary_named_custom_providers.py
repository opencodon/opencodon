...
def _isolate(tmp_path, monkeypatch):
    """Redirect OPENCODON_HOME and clear module caches."""
...
def _write_config(tmp_path, config_dict):
    """Write a config.yaml to the test OPENCODON_HOME."""
    import yaml
...
class TestNormalizeVisionProvider:
    ...
    def test_main_resolves_to_named_custom(self, tmp_path):
        ...
        from opencodon.core.auxiliary_client import _normalize_vision_provider
...
class TestResolveProviderClientMainAlias:
    ...
    def test_main_resolves_github_copilot_alias(self, tmp_path):
        ...
        with (
            patch("opencodon_cli.auth.resolve_api_key_provider_credentials", return_value={
...
class TestVisionPathApiMode:
    ...
    def test_explicit_provider_passes_api_mode(self, tmp_path):
        ...
        with patch("opencodon.core.auxiliary_client._get_cached_client") as mock_gcc:
