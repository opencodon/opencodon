...
def test_slot_reasoning_config_parses_effort_and_none():
    from opencodon.core.moa_loop import _slot_reasoning_config
...
def test_moa_reference_passes_per_slot_reasoning_config(monkeypatch):
    from opencodon.core.moa_loop import _run_reference
    ...
    with patch("opencodon.core.providers.runtime_provider.resolve_runtime_provider") as mock_resolve:
