...
Damien's incident (Discord, 2026-05-28): a long opencodon session in a Discord
...
def test_compression_activity_heartbeat_nonfinite_interval_falls_back(tmp_path: Path) -> None:
    ...
    from opencodon.core.context.conversation_compression import _CompressionActivityHeartbeat
...
def test_restored_anchor_never_creates_consecutive_user_roles() -> None:
    ...
    """
    from opencodon.core.context.conversation_compression import _insert_real_user_anchor
...
def test_lease_refresher_start_exception_releases_lock(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "opencodon.core.context.conversation_compression._CompressionLockLeaseRefresher",
...
def test_review_fork_disables_compression_to_prevent_stale_parent_fork(tmp_path: Path) -> None:
    ...
    """
    import opencodon.core.background_review as br
...
def test_lease_refresher_survives_single_transient_failure() -> None:
    ...
    """
    from opencodon.core.context.conversation_compression import _CompressionLockLeaseRefresher
