...
from opencodon.core.auxiliary_client import _fallback_entry_timeout, _call_fallback_candidate_sync
...
def _fail_with_timeout(compressor, now):
    ...
    ), patch("opencodon.core.context.context_compressor.time.monotonic", return_value=now):
