...
def test_custom_endpoint_anthropic_messages_builds_anthropic_wrapper():
    ...
    from opencodon.core.auxiliary_client import _try_custom_endpoint, AnthropicAuxiliaryClient
...
def test_custom_endpoint_anthropic_messages_falls_back_when_sdk_missing():
    ...
    from opencodon.core.auxiliary_client import _try_custom_endpoint
