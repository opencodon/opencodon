...
def test_rotate_immediately_when_credential_already_exhausted():
    ...
    with patch("opencodon.core.run_agent.get_tool_definitions", return_value=[]),          patch("opencodon.core.run_agent.check_toolset_requirements", return_value={}),          patch("opencodon.core.run_agent.OpenAI"):
