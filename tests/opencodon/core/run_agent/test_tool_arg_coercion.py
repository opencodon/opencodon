...
class TestCoerceToolArgs:
    ...
    def test_coerces_integer_arg(self):
        ...
        with patch("opencodon.tools.model_tools.registry.get_schema", return_value=schema):
            args = {"limit": "10"}
    ...
    def test_unknown_tool_returns_args_unchanged(self):
        with patch("opencodon.tools.model_tools.registry.get_schema", return_value=None):
            args = {"limit": "10"}
