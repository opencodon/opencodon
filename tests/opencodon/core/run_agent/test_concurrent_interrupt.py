...
def _isolate_opencodon(tmp_path, monkeypatch):
...
def _make_agent(monkeypatch):
    ...
    monkeypatch.setenv("OPENCODON_INFERENCE_PROVIDER", "")
...
def test_clear_interrupt_clears_worker_tids(monkeypatch):
    ...
    from opencodon.tools.interrupt import is_interrupted, set_interrupt
