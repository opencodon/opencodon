...
old_session_id=<old>). This lets plugin engines (e.g. opencodon-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See opencodon-lcm#68: after opencodon compresses and mints a new physical session,
