...
def _make_agent() -> AIAgent:
    ...
    with (
        patch("opencodon.core.run_agent.get_tool_definitions", return_value=tool_defs),
...
def test_malformed_arguments_are_rejected_without_blocking_valid_sibling(
    ...
    with (
        patch("opencodon.core.run_agent.handle_function_call", side_effect=fake_dispatch),
