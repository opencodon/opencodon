...
from opencodon.core.context.context_compressor import ContextCompressor, resolve_model_threshold
...
class TestContextCompressorModelThresholds:
    @patch("opencodon.core.context.context_compressor.get_model_context_length", return_value=1_000_000)
    ...
    @patch("opencodon.core.context.context_compressor.get_model_context_length", return_value=256_000)
