...
from opencodon.core.context.context_compressor import ContextCompressor, _CHARS_PER_TOKEN
...
def _make_compressor(**kwargs) -> ContextCompressor:
    ...
    with patch("opencodon.core.context.context_compressor.get_model_context_length", return_value=96000):
