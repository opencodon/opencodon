...
from opencodon.core import trace_upload
...
def test_converter_refuses_unredacted_passthrough_when_redactor_fails(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.redact.redact_sensitive_text", boom)
...
def test_upload_happy_path_mocked(monkeypatch):
    ...
    assert ukwargs["repo_id"] == "alice/opencodon-traces"
