...
from opencodon.core import agent_runtime_helpers as _helpers
from opencodon.core.agent_runtime_helpers import note_turn_start, note_turn_persisted
...
def test_clean_serial_turns_no_warning(caplog):
    agent = _FakeAgent()
    with caplog.at_level(logging.WARNING, logger="opencodon.core.agent_runtime_helpers"):
