...
from opencodon.core.auxiliary_client import call_llm, async_call_llm
...
# (opencodon_cli/config.py).  Simulated here as the config-derived value.
...
def _patches(client, *, task_timeout):
    ...
    return (
        ...
        patch("opencodon.core.auxiliary_client._validate_llm_response",
              side_effect=lambda resp, _task, **_kw: resp),
        patch("opencodon.core.auxiliary_client._get_task_timeout",
