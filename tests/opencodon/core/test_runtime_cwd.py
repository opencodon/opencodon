...
from opencodon.core.runtime_cwd import (
    clear_session_cwd,
    resolve_agent_cwd,
    resolve_context_cwd,
    set_session_cwd,
...
class TestResolveContextCwd:
    ...
    def test_returns_install_tree_when_explicitly_configured(self, monkeypatch):
        ...
        # opencodon source tree is a legitimate workspace when the user is
        # developing opencodon. Only the fallback path (cwd=None → os.getcwd())
