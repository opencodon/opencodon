...
def _run_user_provider_override_case(
    *,
    ...
    with patch("opencodon.frontends.cli.model_switch.resolve_alias", return_value=None), \
         ...
         patch("opencodon.core.models.validate_requested_model", return_value=_REJECTED_VALIDATION), \
         ...
         patch("opencodon.core.runtime_provider.resolve_runtime_provider", return_value={"api_key": "***", "base_url": base_url, "api_mode": "anthropic_messages"}):
        return switch_model(
            raw_input=raw_input,
...
def test_section3_probes_no_key_endpoint_without_explicit_models(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.models.fetch_api_models", _fake_fetch)
...
def test_section3_skips_probe_when_no_key_but_explicit_models(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.models.fetch_api_models", _fail_fetch)
