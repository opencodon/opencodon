"""Tests for opencodon_constants module."""
...
class TestIsContainer:
    ...
    def _reset_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(opencodon_constants, "_container_detected", None)
    ...
    def test_caches_result(self, monkeypatch):
        ...
        monkeypatch.setattr(opencodon_constants, "_container_detected", True)
        assert is_container() is True
...
class TestWslPathTranslation:
    ...
    def test_windows_drive_to_wsl_mount(self):
        assert opencodon_constants.windows_path_to_wsl(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert opencodon_constants.windows_path_to_wsl("C:/Users/alex") == "/mnt/c/Users/alex"
        assert opencodon_constants.windows_path_to_wsl("D:\\") == "/mnt/d/"

    def test_windows_drive_ignores_non_drive_paths(self):
        assert opencodon_constants.windows_path_to_wsl("/home/alex") is None
        assert opencodon_constants.windows_path_to_wsl("relative\\dir") is None

    def test_wsl_unc_to_posix_both_spellings(self):
        assert opencodon_constants.wsl_unc_path_to_posix(r"\\wsl.localhost\Ubuntu\home\alex") == "/home/alex"
        assert opencodon_constants.wsl_unc_path_to_posix(r"\\wsl$\Ubuntu\home\alex") == "/home/alex"
        # Forward-slash spelling and distro root.
        assert opencodon_constants.wsl_unc_path_to_posix("//wsl.localhost/Debian/srv/app") == "/srv/app"
        assert opencodon_constants.wsl_unc_path_to_posix("\\\\wsl.localhost\\Ubuntu\\") == "/"

    def test_wsl_unc_ignores_non_unc_paths(self):
        assert opencodon_constants.wsl_unc_path_to_posix(r"C:\Users\alex") is None
        assert opencodon_constants.wsl_unc_path_to_posix("/home/alex") is None

    def test_translate_is_noop_off_wsl(self, monkeypatch):
        monkeypatch.setattr(opencodon_constants, "is_wsl", lambda: False)
        assert opencodon_constants.translate_cwd_for_wsl_backend(r"C:\Users\alex") == r"C:\Users\alex"
    ...
    def test_translate_maps_windows_and_unc_on_wsl(self, monkeypatch):
        ...
        assert opencodon_constants.translate_cwd_for_wsl_backend(r"C:\Users\alex") == "/mnt/c/Users/alex"
