...
Verifies that:
 ...
 2. User plugins at $OPENCODON_HOME/plugins/model-providers/<name>/ override bundled
...
def test_general_plugin_manager_skips_model_provider_kind(tmp_path, monkeypatch):
    ...
    user_plugin = opencodon_home / "plugins" / "test-model-provider"
