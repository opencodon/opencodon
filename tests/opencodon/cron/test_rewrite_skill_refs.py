"""Tests for opencodon.cron.jobs.rewrite_skill_refs — the curator integration that
...
class TestRewriteSkillRefsNoop:
    ...
    def test_empty_map_and_no_jobs(self, cron_env):
        from opencodon.cron.jobs import rewrite_skill_refs
    ...
    def test_jobs_exist_but_map_empty(self, cron_env):
        from opencodon.cron.jobs import create_job, rewrite_skill_refs
    ...
    def test_jobs_exist_but_no_match(self, cron_env):
        from opencodon.cron.jobs import create_job, get_job, rewrite_skill_refs
...
class TestRewriteSkillRefsPersistence:
    ...
    def test_changes_persist_across_reload(self, cron_env):
        import json
        from opencodon.cron.jobs import create_job, rewrite_skill_refs, JOBS_FILE
