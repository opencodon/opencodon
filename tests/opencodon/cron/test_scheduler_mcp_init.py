...
def test_no_agent_cron_job_does_not_initialize_mcp():
    ...
    with patch("opencodon.tools.mcp_tool.discover_mcp_tools", side_effect=fake_discover), \
         patch("opencodon.cron.scheduler._run_job_script", return_value=(False, "no such file")):
