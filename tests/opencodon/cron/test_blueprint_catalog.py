...
from opencodon.cron.blueprint_catalog import (
    CATALOG,
    BlueprintFillError,
    BlueprintSlot,
    fill_blueprint,
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("opencodon://blueprint/morning-brief?")
    ...
    def test_catalog_entry_has_all_surfaces(self):
        ...
        assert entry["appUrl"].startswith("opencodon://")
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from opencodon.frontends.cli.blueprint_cmd import handle_blueprint_command, match_blueprint
