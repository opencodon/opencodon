"""Tests for opencodon.frontends.server.web_server and related config utilities."""
...
class TestWebServerEndpoints:
    ...
    def test_status_active_session_count_uses_read_only_db(self, monkeypatch, tmp_path):
        ...
        fake_db_path.touch()
        monkeypatch.setattr(opencodon_state, "DEFAULT_DB_PATH", fake_db_path)
    ...
    def test_gateway_drain_begin_writes_marker(self):
        from opencodon.frontends.gateway import drain_control
    ...
    def test_instance_schema_serves_providers_without_declared_schema(self, monkeypatch):
        ...
        resp = self.client.get("/api/memory/providers/customprov/config")
    ...
    def test_dashboard_plugin_providers_rejects_unready_memory_provider(self):
        resp = self.client.put(
            ...
            json={"memory_provider": "not-installed"},
        )
    ...
    def test_get_media_requires_auth(self):
        from opencodon.frontends.server.web_server import _SESSION_HEADER_NAME
    ...
    def test_desktop_audio_routes_registered(self):
        ...
        without failing CI.
        """
        from opencodon.frontends.server.web_server import app
    ...
    def test_get_env_vars_marks_channel_managed_keys(self):
        from opencodon.frontends.server.web_server import _channel_managed_env_keys
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from opencodon.frontends.server.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from opencodon.config import save_env_value
        from opencodon.frontends.server.web_server import _SESSION_TOKEN
    ...
    def test_messaging_catalog_includes_plugin_platforms(self, monkeypatch):
        ...
        from opencodon.frontends.gateway.platform_registry import PlatformEntry, platform_registry
    ...
    def test_path_traversal_dotdot_blocked(self):
        ...
        resp = self.client.get("/%2e%2e/opencodon_cli/web_server.py")
        assert resp.status_code in {200, 404}
        if resp.status_code == 200:
    ...
    def test_apply_main_model_assignment_base_url_and_context_reconcile(self):
        ...
        from opencodon.frontends.server.web_server import _apply_main_model_assignment
    ...
    def test_parse_model_ids_handles_openai_and_bare_shapes(self):
        ...
        from opencodon.frontends.server.web_server import _parse_model_ids
...
class TestBuildSchemaFromConfig:
    ...
    def test_approvals_mode_options_match_config_values(self):
        ...
        are 'manual', 'smart', and 'off' (see opencodon_cli/config.py).
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from opencodon.frontends.server.web_server import _build_schema_from_config
...
class TestNewEndpoints:
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        ...
        import opencodon.frontends.cli.skills_config as skills_config
        import opencodon.frontends.server.web_server as web_server
    ...
    def test_toolsets_list_matches_cli_enabled_state(self, monkeypatch):
        import opencodon.frontends.cli.tools_config as tools_config
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from opencodon.frontends.server.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from opencodon.frontends.server.web_server import _denormalize_config_from_web
        from opencodon.config import save_config
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from opencodon.frontends.server.web_server import _normalise_theme_definition
...
class TestBulkDeleteSessionsEndpoint:
    ...
    1. Route-ordering: ``/api/sessions/bulk-delete`` must shadow the
       ...
       the block comment in ``opencodon_cli/web_server.py``).
    ...
    def test_route_order_not_shadowed_by_session_id(self):
        ...
        assert "deleted" in body, (
            ...
            "registration order in opencodon_cli/web_server.py."
        )
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from opencodon.frontends.server.pty_bridge import PtyUnavailableError
        ...
        import opencodon.frontends.server.web_server as ws_mod
    ...
    def test_pub_broadcasts_to_events_subscribers(self):
        ...
        """
        import asyncio
        from opencodon.frontends.server import web_server as ws_mod
...
def test_resolve_chat_argv_injects_gateway_ws_url(monkeypatch):
    import opencodon.frontends.cli.main as cli_main
    import opencodon.frontends.server.web_server as ws
...
class TestDashboardComponentHealth:
    ...
    def test_storage_degraded_when_state_db_probe_fails(self, monkeypatch):
        import opencodon.frontends.gateway.readiness as readiness
