...
class TestSkillsHubPreviewEndpoint:
    ...
    def test_preview_returns_skill_md_text(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "opencodon.frontends.cli.skills_hub._resolve_source_meta_and_bundle",
...
class TestDebugShareEndpoint:
    ...
    def test_returns_structured_urls(self, monkeypatch):
        import opencodon.frontends.cli.debug as dbg
        ...
        monkeypatch.setattr("opencodon.frontends.cli.dump.run_dump", lambda a: None)
