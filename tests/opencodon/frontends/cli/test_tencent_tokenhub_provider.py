...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in OPENCODON_OVERLAYS
        overlay = OPENCODON_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from opencodon.frontends.cli.providers import OPENCODON_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = OPENCODON_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from opencodon.frontends.cli.models import _KNOWN_PROVIDER_NAMES
