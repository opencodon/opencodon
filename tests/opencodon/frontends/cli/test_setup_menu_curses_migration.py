...
def test_prompt_model_selection_uses_curses_radiolist():
    ...
    with patch("opencodon.frontends.cli.curses_ui.curses_radiolist", side_effect=_fake), \
...
def test_reasoning_effort_uses_curses_radiolist():
    ...
    with patch("opencodon.frontends.cli.curses_ui.curses_radiolist", return_value=2), \
         patch("builtins.print"):
