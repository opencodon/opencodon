...
from opencodon.frontends.cli import send_cmd
...
def test_list_human_output(monkeypatch, capsys):
    ...
    fake_dir = _types.ModuleType("opencodon.frontends.gateway.channel_directory")
    ...
    monkeypatch.setitem(_sys.modules, "opencodon.frontends.gateway.channel_directory", fake_dir)
