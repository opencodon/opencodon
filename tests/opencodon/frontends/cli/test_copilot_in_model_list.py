...
def test_copilot_picker_uses_live_catalog_when_available():
    ...
    with patch("opencodon.core.models_dev.fetch_models_dev", return_value={}), \
         patch("opencodon.frontends.cli.models._resolve_copilot_catalog_api_key", return_value="gh-token"), \
         patch("opencodon.frontends.cli.models._fetch_github_models", return_value=live_models):
