...
def _patch_opencode_pool(monkeypatch, *, available: bool):
    ...
    import opencodon.core.credentials.credential_pool as cp
...
def test_exhausted_pool_provider_is_not_authenticated(monkeypatch):
    ...
    from opencodon.frontends.cli.model_switch import get_authenticated_provider_slugs
...
def test_opaque_legacy_pool_value_stays_visible(monkeypatch):
    ...
    from opencodon.frontends.cli.model_switch import _credential_pool_is_usable
...
def test_picker_shows_exhausted_pool_provider(monkeypatch):
    ...
    from opencodon.frontends.cli.model_switch import list_picker_providers
