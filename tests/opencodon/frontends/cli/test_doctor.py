...
import opencodon.frontends.cli.doctor as doctor
import opencodon.frontends.cli.gateway as gateway_cli
from opencodon.frontends.cli import doctor as doctor_mod
from opencodon.frontends.cli.doctor import _has_provider_env_config
...
class TestHasHealthyOauthFallbackForXai:
    ...
    def test_returns_false_when_xai_import_unavailable(self, monkeypatch):
        ...
        monkeypatch.delattr("opencodon.core.auth.get_xai_oauth_auth_status", raising=False)
