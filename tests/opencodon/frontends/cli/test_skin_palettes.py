...
from opencodon.frontends.cli.skin_engine import _BUILTIN_SKINS
...
# Matches apps/tui/src/theme.ts STRONG/SOFT tiers.
STRONG_FG = (
    "banner_title",
    "banner_accent",
    "banner_text",
...
STRONG_MIN = 3.9
SOFT_MIN = 2.8
# Assumed terminal poles, matching apps/tui/src/theme.ts referenceBackground().
DARK_POLE = "#101014"
LIGHT_POLE = "#ffffff"
