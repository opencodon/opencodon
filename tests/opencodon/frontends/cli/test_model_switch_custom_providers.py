...
import pytest
from opencodon.frontends.cli.model_switch import list_authenticated_providers, switch_model
...
def _disable_live_custom_provider_model_probe(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.cli.models.fetch_api_models", lambda *_a, **_kw: None)
...
def test_list_authenticated_providers_can_skip_custom_provider_live_probe(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.cli.models.fetch_api_models", fetch)
...
def test_switch_model_accepts_explicit_bare_custom_current_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.cli.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
    monkeypatch.setattr("opencodon.frontends.cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("opencodon.frontends.cli.model_switch.get_model_capabilities", lambda *a, **k: None)
...
def test_custom_provider_no_key_singular_model_still_probes_live_models(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.cli.models.fetch_api_models", fake_fetch_api_models)
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.cli.models.fetch_lmstudio_models", _fake_fetch)
...
def test_custom_providers_uses_live_models_for_multi_model_endpoint(monkeypatch):
    ...
    """
    monkeypatch.setattr("opencodon.core.models_dev.fetch_models_dev", lambda: {})
    monkeypatch.setattr("opencodon.frontends.cli.providers.OPENCODON_OVERLAYS", {})
...
def test_resolve_custom_provider_passes_key_env():
    ...
    """
    from opencodon.frontends.cli.providers import resolve_custom_provider
...
def test_discovered_models_auto_saved_to_cache(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.cli.models.fetch_api_models", fake_fetch_api_models)
    monkeypatch.setattr(
        "opencodon.frontends.cli.model_switch._save_discovered_models_to_config",
...
def test_save_discovered_models_skips_unchanged(monkeypatch):
    ...
    from opencodon.frontends.cli.model_switch import _save_discovered_models_to_config
