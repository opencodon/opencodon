...
def _disable_live_custom_provider_model_probe(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.providers.models.fetch_api_models", lambda *_a, **_kw: None)
...
def test_list_authenticated_providers_can_skip_custom_provider_live_probe(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.providers.models.fetch_api_models", fetch)
...
def test_switch_model_accepts_explicit_bare_custom_current_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.providers.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
...
def test_custom_provider_no_key_singular_model_still_probes_live_models(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.providers.models.fetch_api_models", fake_fetch_api_models)
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.core.providers.models.fetch_lmstudio_models", _fake_fetch)
...
def test_custom_providers_uses_live_models_for_multi_model_endpoint(monkeypatch):
    ...
    """
    monkeypatch.setattr("opencodon.core.providers.models_dev.fetch_models_dev", lambda: {})
    monkeypatch.setattr("opencodon.core.providers.OPENCODON_OVERLAYS", {})
...
def test_resolve_custom_provider_passes_key_env():
    ...
    """
    from opencodon.core.providers import resolve_custom_provider
