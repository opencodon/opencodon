"""Tests for `opencodon chat --safe-mode` isolation."""
...
def test_prepare_agent_startup_applies_safe_mode_before_plugin_discovery(monkeypatch):
    ...
    plugins = types.ModuleType("opencodon.plugins_runtime")
    ...
    monkeypatch.setitem(sys.modules, "opencodon.plugins_runtime", plugins)
