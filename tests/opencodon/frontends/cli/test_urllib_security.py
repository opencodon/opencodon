...
from opencodon.frontends.cli.urllib_security import (
...
def test_installed_custom_opener_policy_is_preserved(monkeypatch):
    ...
    from opencodon.frontends.cli.urllib_security import _secure_opener_from_installed_policy
...
def test_lmstudio_load_post_drops_bearer_on_redirect(monkeypatch):
    from opencodon.frontends.cli import models
