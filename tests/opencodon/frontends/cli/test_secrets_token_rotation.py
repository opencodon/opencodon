"""Tests for `opencodon secrets bitwarden token` / `opencodon secrets onepassword token`.
...
from opencodon.frontends.cli import onepassword_secrets_cli as op_cli
from opencodon.frontends.cli import secrets_cli as bw_cli
