...
def test_prompt_reasoning_effort_falls_back_on_menu_runtime_error(monkeypatch):
    from opencodon.frontends.cli.main import _prompt_reasoning_effort_selection
...
def test_remove_custom_provider_falls_back_on_menu_runtime_error(tmp_path, monkeypatch):
    from opencodon.frontends.cli.main import _remove_custom_provider
...
def test_named_custom_provider_model_picker_falls_back_on_menu_runtime_error(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("OPENCODON_HOME", str(tmp_path))
    monkeypatch.setattr("opencodon.frontends.cli.curses_ui.curses_radiolist", _raise_menu)
    monkeypatch.setattr("opencodon.core.providers.models.fetch_api_models", lambda *args, **kwargs: ["model-a", "model-b"])
