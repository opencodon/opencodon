...
class TestResolveDisplayContextLength:
    ...
    def test_falls_back_to_model_info_when_resolver_returns_none(self):
        ...
        with patch(
            "opencodon.core.providers.model_metadata.get_model_context_length", return_value=None
        ):
            ctx = resolve_display_context_length(
                "some-model",
                "some-provider",
    ...
    def test_prefers_resolver_even_when_model_info_has_larger_value(self):
        ...
        with patch(
            "opencodon.core.providers.model_metadata.get_model_context_length", return_value=128_000
        ):
            ctx = resolve_display_context_length(
                "capped-model",
                "capped-provider",
