...
from opencodon.frontends.cli.proxy.adapters import ADAPTERS, get_adapter
from opencodon.frontends.cli.proxy.adapters.base import UpstreamAdapter, UpstreamCredential
from opencodon.frontends.cli.proxy.adapters.xai import XAIGrokAdapter
...
from opencodon.frontends.cli.proxy.server import create_app  # noqa: E402
...
def test_cmd_proxy_status_runs(capsys, tmp_path, monkeypatch):
    monkeypatch.setenv("OPENCODON_HOME", str(tmp_path))
    from opencodon.frontends.cli.proxy.cli import cmd_proxy_status
...
def test_cmd_proxy_providers_runs(capsys):
    from opencodon.frontends.cli.proxy.cli import cmd_proxy_list_providers
...
def test_cmd_proxy_start_refuses_unknown_provider(capsys):
    from opencodon.frontends.cli.proxy.cli import cmd_proxy_start
