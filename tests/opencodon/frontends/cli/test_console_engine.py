...
from opencodon.frontends.cli.console_engine import OpencodonConsoleEngine, run_console_repl
...
def test_console_status_hides_cli_next_step_footer(
    ...
    import opencodon.frontends.cli.status as status_mod
...
def test_main_console_subcommand_smoke(_isolate_opencodon_home):
    ...
    result = subprocess.run(
        [sys.executable, "-m", "opencodon.frontends.cli.main", "console"],
