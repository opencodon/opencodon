"""Tests for the interactive session browser (`opencodon sessions browse`).
...
from opencodon.frontends.cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """opencodon sessions browse should be parseable."""
