...
from opencodon.frontends.cli import setup as setup_mod
from opencodon.frontends.cli.setup import setup_model_provider
...
def test_setup_gateway_skips_service_install_when_systemctl_missing(monkeypatch, capsys):
    ...
    import opencodon.frontends.cli.gateway as _gw_mod
    ...
    assert "opencodon gateway" in out
...
def test_select_provider_and_model_warns_if_named_custom_provider_disappears(
    ...
    monkeypatch.setattr("opencodon.frontends.cli.auth.resolve_provider", lambda provider: None)
...
def test_select_provider_and_model_accepts_named_provider_from_providers_section(
    ...
    monkeypatch.setattr(
        "opencodon.frontends.cli.main._prompt_provider_choice",
