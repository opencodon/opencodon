"""Tests for opencodon_cli.web_server and related config utilities."""
...
class TestWebServerEndpoints:
    ...
    def test_get_media_requires_auth(self):
        from opencodon.frontends.cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_desktop_audio_routes_registered(self):
        ...
        without failing CI.
        """
        from opencodon.frontends.cli.web_server import app
    ...
    def test_get_env_vars_marks_channel_managed_keys(self):
        from opencodon.frontends.cli.web_server import _channel_managed_env_keys
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from opencodon.frontends.cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from opencodon.config import save_env_value
        from opencodon.frontends.cli.web_server import _SESSION_TOKEN
    ...
    def test_apply_main_model_assignment_base_url_and_context_reconcile(self):
        ...
        from opencodon.frontends.cli.web_server import _apply_main_model_assignment
    ...
    def test_parse_model_ids_handles_openai_and_bare_shapes(self):
        ...
        from opencodon.frontends.cli.web_server import _parse_model_ids
...
class TestBuildSchemaFromConfig:
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from opencodon.frontends.cli.web_server import _build_schema_from_config
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from opencodon.frontends.cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from opencodon.frontends.cli.web_server import _denormalize_config_from_web
        from opencodon.config import save_config
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from opencodon.frontends.cli.web_server import _normalise_theme_definition
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from opencodon.frontends.cli.pty_bridge import PtyUnavailableError
        ...
        import opencodon.frontends.cli.web_server as ws_mod
    ...
    def test_pub_broadcasts_to_events_subscribers(self):
        ...
        """
        import asyncio
        from opencodon.frontends.cli import web_server as ws_mod
