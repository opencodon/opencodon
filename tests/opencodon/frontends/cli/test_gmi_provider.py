...
class TestGmiModelCatalog:
    ...
    def test_provider_model_ids_falls_back_to_static_models(self, monkeypatch):
        ...
        monkeypatch.setattr("opencodon.core.models.fetch_api_models", lambda api_key, base_url: None)
...
class TestGmiDoctor:
    def test_provider_env_hints_include_gmi(self):
        from opencodon.frontends.cli.doctor import _PROVIDER_ENV_HINTS
...
class TestGmiMainFlow:
    def test_chat_parser_accepts_gmi_provider(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "opencodon.frontends.cli.main.cmd_chat",
    ...
    def test_select_provider_and_model_routes_gmi_to_generic_flow(self, monkeypatch):
        ...
        monkeypatch.setattr("opencodon.core.auth.resolve_provider", lambda *args, **kwargs: None)
        ...
        monkeypatch.setattr("opencodon.frontends.cli.main._model_flow_api_key_provider", fake_model_flow_api_key_provider)
