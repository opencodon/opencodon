"""Tests for MCP tools interactive configuration in opencodon_cli.tools_config."""

from unittest.mock import patch

from opencodon.frontends.cli.tools_config import _configure_mcp_tools_interactive
...
_CHECKLIST = "opencodon.frontends.cli.curses_ui.curses_checklist"
_SAVE = "opencodon.frontends.cli.tools_config.save_config"
...
def test_disabling_tool_writes_include_list(capsys):
    ...
    catalog flow, `opencodon mcp configure`, and this UI all write the same
