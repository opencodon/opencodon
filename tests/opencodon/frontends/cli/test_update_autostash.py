...
def _patch_managed_uv(request):
    ...
    with patch("opencodon.frontends.cli.managed_uv.resolve_uv", side_effect=_fake_resolve_uv), \
         patch("opencodon.frontends.cli.managed_uv.ensure_uv", side_effect=_fake_ensure_uv), \
         patch("opencodon.frontends.cli.managed_uv.update_managed_uv", side_effect=_fake_update_managed_uv):
        yield
