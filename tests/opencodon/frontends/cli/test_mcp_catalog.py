"""Tests for opencodon_cli.mcp_catalog and opencodon_cli.mcp_picker.
...
def _entry(name: str):
    ...
    from opencodon.frontends.cli.mcp_catalog import get_entry
...
class TestManifestParsing:
    def test_minimal_valid(self, catalog_dir):
        ...
        from opencodon.frontends.cli.mcp_catalog import list_catalog
    ...
    def test_transport_env_parsed_and_written_to_server_config(self, catalog_dir):
        ...
        _write_manifest(catalog_dir, "demo", body)
        from opencodon.frontends.cli.mcp_catalog import _build_server_config
...
class TestInstall:
    def test_install_simple_stdio_writes_config(self, catalog_dir):
        _write_manifest(catalog_dir, "demo", _basic_manifest())
        from opencodon.frontends.cli.mcp_catalog import install_entry
    ...
    def test_install_rejects_exfil_shaped_stdio_manifest(self, catalog_dir):
        ...
        from opencodon.config import load_config
        from opencodon.frontends.cli.mcp_catalog import CatalogError, install_entry
    ...
    def test_install_required_env_missing_raises(self, catalog_dir, monkeypatch):
        ...
        from opencodon.frontends.cli import mcp_catalog
        from opencodon.frontends.cli.mcp_catalog import install_entry, CatalogError
...
class TestUninstall:
    def test_uninstall_removes_server_block(self, catalog_dir):
        _write_manifest(catalog_dir, "demo", _basic_manifest())
        from opencodon.frontends.cli.mcp_catalog import install_entry, uninstall_entry
        from opencodon.config import load_config
    ...
    def test_uninstall_missing_returns_false(self):
        from opencodon.frontends.cli.mcp_catalog import uninstall_entry
...
class TestCatalogDiagnostics:
    def test_future_manifest_version_skipped_with_diagnostic(self, catalog_dir):
        ...
        from opencodon.frontends.cli.mcp_catalog import list_catalog, catalog_diagnostics
...
class TestGitInstallShaRef:
    def test_sha_ref_skips_branch_attempt(self, catalog_dir, monkeypatch, tmp_path):
        ...
        from opencodon.frontends.cli import mcp_catalog
        from opencodon.frontends.cli.mcp_catalog import _do_git_install
    ...
    def test_branch_ref_uses_branch_clone(self, catalog_dir, monkeypatch):
        ...
        from opencodon.frontends.cli import mcp_catalog
        from opencodon.frontends.cli.mcp_catalog import _do_git_install, get_entry
...
class TestToolsConfigIncludeMode:
    def test_configure_mcp_writes_include_not_exclude(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(
            "opencodon.frontends.cli.curses_ui.curses_checklist",
...
class TestShippedCatalog:
    def test_all_shipped_manifests_parse(self, monkeypatch):
        ...
        from opencodon.frontends.cli.mcp_catalog import _catalog_root, _parse_manifest
