...
import opencodon.frontends.cli.memory_setup as memory_setup
from opencodon.frontends.cli.memory_setup import _CANCELLED, _curses_select
...
def test_curses_select_cancel_defaults_to_selected(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.cli.curses_ui.curses_radiolist", fake_radiolist)
...
def test_cmd_setup_clears_interactive_picker_before_provider_post_setup(monkeypatch):
    ...
    class PostSetupProvider:
        def post_setup(self, opencodon_home, config):
