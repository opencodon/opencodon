"""Tests for the ``opencodon prompt-size`` diagnostic (issue #34667)."""
...
from opencodon.frontends.cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(opencodon_home, memory_text="", user_text=""):
    mem_dir = opencodon_home / "memories"
...
def _seed_skill(opencodon_home, name, description):
    skill_dir = opencodon_home / "skills" / "demo" / name
