"""Tests for opencodon_cli.security_advisories.
...
import opencodon.frontends.cli.security_advisories as adv
...
def isolated_home(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Path:
    """Redirect OPENCODON_HOME so banner cache and config writes are sandboxed."""
...
class TestRendering:
    def test_short_banner_lines_includes_id_and_version(self, fake_advisory):
        ...
        assert "opencodon doctor" in joined
