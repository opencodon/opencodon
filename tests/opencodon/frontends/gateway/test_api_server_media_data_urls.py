...
from opencodon.frontends.gateway.platforms.api_server import _resolve_media_to_data_urls  # noqa: E402
...
class TestResolveMediaToDataUrls(unittest.TestCase):
    def _write_png(self, tmpdir_name="opencodon_media_test"):
        import tempfile
    ...
    def test_oversized_image_skipped(self):
        from opencodon.frontends.gateway.platforms import api_server as mod
    ...
    def test_multiple_tags(self):
        p1 = self._write_png()
        p2 = self._write_png("opencodon_media_test2")
    ...
    def test_symlink_escaping_to_denylisted_target_not_inlined(self):
        ...
        d = Path(tempfile.mkdtemp(prefix="opencodon_media_test_symlink"))
        link = d / "shot.png"
        try:
