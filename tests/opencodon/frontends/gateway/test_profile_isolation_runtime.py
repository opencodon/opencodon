...
``_OPENCODON_HOME_OVERRIDE`` ContextVar, not the process environment.  State that
...
with real temp OPENCODON_HOME directories (no mocks) and assert the *active*
...
def two_profiles(tmp_path):
    """Two distinct profile OPENCODON_HOME dirs with the dir skeleton created."""
