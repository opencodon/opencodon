...
from opencodon.frontends.gateway.relay import register_relay_adapter, relay_url
...
def test_off_when_no_url_configured(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.gateway.relay.relay_url", lambda: None)
