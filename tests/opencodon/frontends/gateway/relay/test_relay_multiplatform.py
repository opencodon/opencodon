...
import opencodon.frontends.gateway.relay as relay
...
def _clean_env(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.gateway.run._load_gateway_config", lambda: {}, raising=False)
...
async def test_adapter_stamps_per_frame_platform_from_inbound(monkeypatch):
    ...
    from tests.opencodon.frontends.gateway.relay.stub_connector import StubConnector
