...
from opencodon.frontends.gateway.platform_registry import PlatformRegistry, PlatformEntry
from opencodon.frontends.gateway.config import Platform, GatewayConfig
...
class TestPlatformEnumDynamic:
    ...
    def _register_fake(name):
        from opencodon.frontends.gateway.platform_registry import platform_registry as _reg
...
class TestPlatformsMerge:
    ...
    def test_get_all_platforms_includes_builtins(self):
        from opencodon.frontends.cli.platforms import get_all_platforms, PLATFORMS
        merged = get_all_platforms()
        for key in PLATFORMS:
            assert key in merged

    def test_get_all_platforms_includes_plugin(self):
        from opencodon.frontends.cli.platforms import get_all_platforms
        from opencodon.frontends.gateway.platform_registry import platform_registry as _reg
