...
from opencodon.frontends.gateway.config import Platform, HomeChannel, GatewayConfig, PlatformConfig
...
class TestBuildSessionContextPrompt:
    ...
    def test_discord_prompt_stable_across_message_id(self):
        ...
        import opencodon.frontends.gateway.session as _gs
...
class TestSessionEntryFromDictTraversalValidation:
    ...
    def _entry(self, **overrides):
        from opencodon.frontends.gateway.session import SessionEntry
