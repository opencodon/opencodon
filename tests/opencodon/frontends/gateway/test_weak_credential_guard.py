...
from opencodon.frontends.gateway.config import PlatformConfig, Platform, _validate_gateway_config
...
class TestAPIServerPlaceholderKeyGuard:
    ...
    async def test_refuses_wildcard_with_short_random_key(self):
        ...
        June 2026 opencodon-0day hardening raised the network-bind entropy floor
