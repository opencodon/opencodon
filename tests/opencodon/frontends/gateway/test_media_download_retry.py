...
class TestCacheImageFromBytes:
    ...
    def test_caches_valid_jpeg(self, tmp_path, monkeypatch):
        monkeypatch.setattr("opencodon.frontends.gateway.platforms.base.IMAGE_CACHE_DIR", tmp_path / "img")
    ...
    def test_success_on_first_attempt(self, _mock_safe, tmp_path, monkeypatch):
        ...
        async def run():
            with patch("httpx.AsyncClient", return_value=mock_client):
                from opencodon.frontends.gateway.platforms.base import cache_image_from_url
...
class TestCacheAudioFromUrl:
    ...
    def test_success_on_first_attempt(self, _mock_safe, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("opencodon.frontends.gateway.platforms.base.AUDIO_CACHE_DIR", tmp_path / "audio")
        ...
        async def run():
            with patch("httpx.AsyncClient", return_value=mock_client):
                from opencodon.frontends.gateway.platforms.base import cache_audio_from_url
...
from opencodon.frontends.gateway.config import PlatformConfig  # noqa: E402
