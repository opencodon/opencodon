...
def _make_adapter(**overrides):
    ...
    """
    from opencodon.frontends.gateway.platforms.whatsapp_cloud import WhatsAppCloudAdapter
...
class TestWebhookSignature:
    ...
    async def test_oversize_body_rejected_before_signature(self):
        ...
        from opencodon.frontends.gateway.platforms.whatsapp_cloud import WEBHOOK_MAX_BODY_BYTES
...
class TestWebhookReplay:
    ...
    def test_dedup_cache_evicts_oldest(self):
        from opencodon.frontends.gateway.platforms.whatsapp_cloud import WAMID_DEDUP_CACHE_SIZE
        adapter = _make_adapter()
...
class TestDownloadMedia:
    ...
    async def test_two_step_download_writes_cache_file(self, tmp_path):
        from opencodon.frontends.gateway.platforms import whatsapp_cloud as wac
...
class TestBoundedInteractiveState:
    def test_bounded_put_evicts_oldest(self):
        ...
        from opencodon.frontends.gateway.platforms.whatsapp_cloud import (
