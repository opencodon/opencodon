    ...
    def test_load_voice_modes_skips_legacy_keys(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch.object(runner, "_VOICE_MODE_PATH", voice_path):
                with patch("opencodon.frontends.gateway.run.logger") as mock_logger:
...
def _make_runner() -> GatewayRunner:
    ...
    with patch("opencodon.frontends.gateway.run.GatewayRunner._load_voice_modes", return_value={}):
