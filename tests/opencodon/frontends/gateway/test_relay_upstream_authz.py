...
def test_event_from_wire_sets_relay_delivery_marker():
    ...
    """
    from opencodon.frontends.gateway.relay.ws_transport import _event_from_wire
...
def test_event_from_wire_stamps_routed_profile():
    ...
    In multiplex mode the connector resolves the target OPENCODON profile for a
