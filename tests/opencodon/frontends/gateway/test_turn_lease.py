...
from opencodon.frontends.gateway.turn_lease import SessionTurnLeaseRegistry
...
def test_contention_logs_named_warning(caplog):
    ...
    with caplog.at_level("WARNING", logger="opencodon.frontends.gateway.turn_lease"):
        _run(scenario())
...
def test_timeout_fails_open_with_degraded_token(caplog):
    ...
    with caplog.at_level("ERROR", logger="opencodon.frontends.gateway.turn_lease"):
        _run(scenario())
