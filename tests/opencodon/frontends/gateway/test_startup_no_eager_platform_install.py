...
from opencodon.frontends.gateway.config import GatewayConfig, Platform, PlatformConfig, _apply_env_overrides
...
def isolated_registry():
    ...
    try:
        ...
        with patch("opencodon.plugins_runtime.discover_plugins", lambda *a, **k: None):
