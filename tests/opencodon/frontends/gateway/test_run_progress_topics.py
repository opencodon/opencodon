...
import opencodon.frontends.gateway.platforms.base as base_platform
from opencodon.frontends.gateway.config import Platform, PlatformConfig, StreamingConfig
from opencodon.frontends.gateway.platforms.base import BasePlatformAdapter, MessageEvent, MessageType, SendResult
...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.opencodon/opencodon/.worktrees/opencodon-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
def _make_runner(adapter):
    gateway_run = importlib.import_module("opencodon.frontends.gateway.run")
...
async def test_terminal_progress_verbose_shows_full_command(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("OPENCODON_TOOL_PROGRESS_MODE", "verbose")
