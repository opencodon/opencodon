...
from tests.opencodon.frontends.gateway.test_discord_connect import (  # noqa: E402
    FakeBot,
...
from opencodon.frontends.gateway.config import Platform, PlatformConfig  # noqa: E402
from opencodon.frontends.gateway.run import GatewayRunner  # noqa: E402
...
async def _connect(adapter: DiscordAdapter, monkeypatch, bot_factory):
    monkeypatch.setattr(
        "opencodon.frontends.gateway.status.acquire_scoped_lock",
