...
from opencodon.frontends.gateway.run import GatewayRunner, start_gateway
from tests.opencodon.frontends.gateway.restart_test_helpers import make_restart_runner
...
def test_runner_starts_watchdog_only_after_running(monkeypatch):
    ...
    monkeypatch.setattr("opencodon.frontends.gateway.systemd_notify.SystemdWatchdog", _FakeWatchdog)
