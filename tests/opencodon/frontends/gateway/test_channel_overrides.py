...
from opencodon.frontends.gateway.run import _get_channel_override, GatewayRunner
...
class TestResolveModelForChannel:
    ...
    def test_falls_back_to_global_when_no_override(self, monkeypatch):
        monkeypatch.setattr(
            "opencodon.frontends.gateway.run._resolve_gateway_model",
...
class TestResolveSessionAgentRuntimePriority:
    ...
    def test_channel_override_beats_global(self):
        ...
        with patch("opencodon.frontends.gateway.run._resolve_gateway_model", return_value="global/model"), \
