...
from opencodon.frontends.gateway.profile_routing import ProfileRoute
        ...
        with patch("opencodon.frontends.cli.profiles.get_active_profile_name", return_value="active"):
            with patch("opencodon.frontends.cli.profiles.get_profile_dir") as mock_get_dir:
                with patch("opencodon.frontends.cli.profiles.profile_exists", return_value=True):
                    ...
                    assert result == Path("/opencodon/profiles/from-source")
        ...
        with patch("opencodon.frontends.cli.profiles.get_active_profile_name", return_value="active"):
            with patch("opencodon.frontends.cli.profiles.get_profile_dir") as mock_get_dir:
                with patch("opencodon.frontends.cli.profiles.profile_exists", return_value=True):
                    ...
                    assert result == Path("/opencodon/profiles/routed")
    ...
    def test_active_profile_fallback(self, mock_runner, discord_source):
        ...
        with patch("opencodon.frontends.cli.profiles.get_active_profile_name", return_value="active"):
            with patch("opencodon.frontends.cli.profiles.get_profile_dir") as mock_get_dir:
                ...
                assert result == Path("/opencodon/profiles/active")
            ...
            with patch("opencodon.frontends.cli.profiles.get_profile_dir") as mock_get_dir:
                ...
                with patch("opencodon.frontends.cli.profiles.profile_exists", return_value=True):
                    with caplog.at_level(logging.WARNING):
                        ...
                        assert result == Path("/opencodon/profiles/existing")
