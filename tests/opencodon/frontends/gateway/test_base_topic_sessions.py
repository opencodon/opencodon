...
from opencodon.frontends.gateway.platforms.base import BasePlatformAdapter, MessageEvent, MessageType, ProcessingOutcome, SendResult
...
class TestTelegramAutoTtsCaptionDelivery:
    ...
    async def test_short_telegram_auto_tts_uses_caption_without_followup_text(self, tmp_path):
        ...
        with patch("opencodon.tools.tts_tool.check_tts_requirements", return_value=True), patch(
            "opencodon.tools.tts_tool.text_to_speech_tool",
