...
from opencodon.frontends.gateway.platforms.api_server import APIServerAdapter, ResponseStore
from opencodon.frontends.gateway.platforms.base import BasePlatformAdapter, SendResult
from opencodon.frontends.gateway.run import GatewayRunner, _dispose_unused_adapter
...
class TestAPIServerDisconnectClosesResponseStore:
    ...
    async def test_disconnect_closes_response_store(self, tmp_path):
        ...
        to ``~/.opencodon/response_store.db`` (or :memory: as a fallback),
