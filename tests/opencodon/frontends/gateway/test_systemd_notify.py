...
def test_notify_without_notify_socket_is_a_noop(monkeypatch):
    ...
    from opencodon.frontends.gateway.systemd_notify import notify
...
def test_notify_uses_nonblocking_datagram_send(monkeypatch):
    ...
    import opencodon.frontends.gateway.systemd_notify as notify_mod
...
def test_watchdog_interval_is_disabled_for_missing_invalid_or_nonpositive_values(
    ...
    from opencodon.frontends.gateway.systemd_notify import watchdog_interval_seconds
