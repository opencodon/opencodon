    ...
    async def test_start_returns_202(self, adapter):
        ...
        async with TestClient(TestServer(app)) as cli:
            with patch.object(adapter, "_create_agent") as mock_create:
                ...
                assert status["object"] == "opencodon.run"
    ...
    async def test_expired_live_run_drops_transport_but_keeps_control_state(self, adapter):
        ...
        async with TestClient(TestServer(app)) as cli:
            with patch.object(adapter, "_create_agent") as mock_create:
                ...
                with patch(
                    "opencodon.frontends.gateway.platforms.api_server.asyncio.sleep",
...
class TestStopRun:
    ...
    async def test_stop_before_agent_creation_prevents_run_start(self, adapter):
        ...
        with patch("opencodon.frontends.gateway.platforms.api_server.asyncio.create_task", side_effect=_delayed_create_task), \
