...
import opencodon.frontends.cli.cli_output as cli_output_mod
...
def _patch_setup_io(monkeypatch, prompts, saved):
    ...
    # Manifest writing reaches out to opencodon_cli.slack_cli + filesystem; stub it.
    import opencodon.frontends.cli.slack_cli as slack_cli_mod
