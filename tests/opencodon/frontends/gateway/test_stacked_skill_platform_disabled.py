...
the first (``opencodon.core.skills.skill_commands.split_stacked_skill_commands`` /
...
def _make_runner():
    ...
    from opencodon.frontends.gateway.run import GatewayRunner as _GR
...
def skills_env(tmp_path, monkeypatch):
    ...
    import opencodon.core.skills.skill_commands as skill_commands_mod
...
async def test_stacked_second_skill_disabled_for_platform_is_blocked(monkeypatch, skills_env):
    ...
    import opencodon.core.skills.skill_utils as skill_utils_mod
