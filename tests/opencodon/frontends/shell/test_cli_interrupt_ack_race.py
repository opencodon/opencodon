...
Root cause: ``OpencodonCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a OpencodonCLI with prompt_toolkit stubbed (same pattern as
