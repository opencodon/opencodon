"""Tests for OpencodonCLI initialization -- catches configuration bugs
...
def _make_cli(env_overrides=None, config_overrides=None, **kwargs):
    ...
    with patch.dict(sys.modules, prompt_toolkit_stubs), \
        ...
        _cli_mod = importlib.import_module("opencodon.frontends.cli.shell")
        _cli_mod = importlib.reload(_cli_mod)
        with patch.object(_cli_mod, "get_tool_definitions", return_value=[]), \
             patch.dict(_cli_mod.__dict__, {"CLI_CONFIG": _clean_config}):
            return _cli_mod.OpencodonCLI(**kwargs)
...
class TestPromptToolkitTerminalCompatibility:
    def test_lf_enter_binds_to_submit_handler_posix(self):
        ...
        from opencodon.frontends.cli.shell import _bind_prompt_submit_keys
    ...
    def test_cpr_warning_callback_is_disabled(self):
        from opencodon.frontends.cli.shell import _disable_prompt_toolkit_cpr_warning
    ...
    def test_cpr_disabled_output_marks_renderer_not_supported(self):
        ...
        """
        import sys as _sys
        from opencodon.frontends.cli.shell import _build_cpr_disabled_output
    ...
    def test_cpr_gating_posix_local_and_windows_preserve(self, monkeypatch):
        ...
        from opencodon.frontends.cli.shell import _terminal_may_leak_cpr
...
class TestHistoryDisplay:
    ...
    def test_history_shows_recent_sessions_when_current_chat_is_empty(self, capsys):
        ...
        cli._session_db.list_sessions_rich.return_value = [
            ...
            },
            {
                ...
                "title": "Checking Running opencodon",
                "preview": "check running gateways for opencodon agent",
                "last_active": 0,
            },
        ]
        ...
        assert "Checking Running opencodon" in output
    ...
    def test_resume_updates_opencodon_session_id_env_and_context(self, tmp_path):
        from opencodon.frontends.gateway.session_context import _UNSET, _VAR_MAP, get_session_env
    ...
    def test_sessions_with_target_delegates_to_resume(self):
        ...
        with patch.object(cli, "_handle_resume_command") as mock_resume:
            cli.process_command("/sessions Checking Running opencodon")

        mock_resume.assert_called_once_with(
            "/resume Checking Running opencodon"
        )
