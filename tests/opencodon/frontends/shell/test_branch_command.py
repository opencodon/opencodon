...
def cli_instance(tmp_path, session_db):
    """Create a minimal OpencodonCLI-like object for testing _handle_branch_command."""
...
class TestBranchCommandCLI:
    ...
    def test_branch_creates_new_session(self, cli_instance, session_db):
        ...
        OpencodonCLI._handle_branch_command(cli_instance, "/branch")
    ...
    def test_branch_with_custom_name(self, cli_instance, session_db):
        ...
        OpencodonCLI._handle_branch_command(cli_instance, "/branch refactor approach")
    ...
    def test_branch_rotates_opencodon_session_id_env_and_context(self, cli_instance, session_db):
...
class TestBranchCommandDef:
    ...
    def test_branch_in_registry(self):
        ...
        from opencodon.frontends.cli.commands import COMMAND_REGISTRY
