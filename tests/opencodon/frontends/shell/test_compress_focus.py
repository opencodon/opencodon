...
from tests.opencodon.frontends.shell.test_cli_init import _make_cli
...
def test_focus_topic_extracted_and_passed(capsys):
    ...
    with patch("opencodon.core.providers.model_metadata.estimate_messages_tokens_rough", side_effect=_estimate):
