...
from opencodon.frontends.cli.commands import GATEWAY_KNOWN_COMMANDS, resolve_command
...
def test_process_command_version_prints_version_info():
    ...
    with patch("opencodon.frontends.cli.main._print_version_info") as mock_print:
