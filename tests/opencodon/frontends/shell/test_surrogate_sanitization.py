...
class TestRunConversationSurrogateSanitization:
    ...
    @patch("opencodon.core.run_agent.AIAgent._build_system_prompt")
    @patch("opencodon.core.run_agent.AIAgent._interruptible_streaming_api_call")
    @patch("opencodon.core.run_agent.AIAgent._interruptible_api_call")
