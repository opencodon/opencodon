...
def test_load_interim_assistant_messages_defaults_true():
    from opencodon.frontends.tui.server import _load_interim_assistant_messages

    with patch("opencodon.frontends.tui.server._load_cfg", return_value={}):
...
def test_load_interim_assistant_messages_explicit_true():
    ...
    with patch("opencodon.frontends.tui.server._load_cfg", return_value={"display": {"interim_assistant_messages": True}}):
        assert _load_interim_assistant_messages() is True
...
def test_load_interim_assistant_messages_explicit_false():
    ...
    with patch("opencodon.frontends.tui.server._load_cfg", return_value={"display": {"interim_assistant_messages": False}}):
...
def test_load_interim_assistant_messages_string_off():
    ...
    with patch("opencodon.frontends.tui.server._load_cfg", return_value={"display": {"interim_assistant_messages": "off"}}):
        assert _load_interim_assistant_messages() is False
...
def test_agent_cbs_includes_interim_callback_when_enabled():
    ...
    """
    from opencodon.frontends.tui.server import _agent_cbs
    ...
    with patch("opencodon.frontends.tui.server._load_cfg", return_value={}), \
         patch("opencodon.frontends.tui.server._emit", side_effect=fake_emit):
