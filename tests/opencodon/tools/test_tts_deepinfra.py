...
``tests/opencodon_cli/test_api_key_providers.py``.
"""
...
def test_raises_when_no_model_resolvable(monkeypatch, tmp_path):
    ...
    from opencodon.tools.tts_tool import _generate_deepinfra_tts
...
def test_delegates_to_openai_handler_with_deepinfra_creds(monkeypatch, tmp_path):
    ...
    with patch("opencodon.tools.tts_tool._import_openai_client", return_value=_FakeClient):
        from opencodon.tools.tts_tool import _generate_deepinfra_tts
