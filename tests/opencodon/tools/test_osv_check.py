...
from opencodon.tools.osv_check import (
...
class TestCheckPackageForMalware:
    def test_clean_package(self):
        ...
        with patch("opencodon.tools.osv_check.urllib.request.urlopen", return_value=mock_response):
    ...
    def test_network_error_fails_open(self):
        ...
        with patch("opencodon.tools.osv_check.urllib.request.urlopen", side_effect=ConnectionError("timeout")):
    ...
    def test_uvx_pypi(self):
        ...
        with patch("opencodon.tools.osv_check.urllib.request.urlopen", return_value=mock_response) as mock_url:
