...
def fresh_tracker():
    ...
    from opencodon.tools.file_tools import _patch_failure_tracker, _patch_failure_lock
...
class TestPatchFailureEscalation:
    def test_first_two_failures_use_normal_hint(self, opencodon_home, tmp_path, fresh_tracker):
    ...
    def test_third_consecutive_failure_escalates(self, opencodon_home, tmp_path, fresh_tracker):
        from opencodon.tools.file_tools import _handle_patch
    ...
    def test_success_clears_failure_counter(self, opencodon_home, tmp_path, fresh_tracker):
        from opencodon.tools.file_tools import _handle_patch
    ...
    def test_different_paths_have_independent_counters(
        self, opencodon_home, tmp_path, fresh_tracker
    ):
        from opencodon.tools.file_tools import _handle_patch
