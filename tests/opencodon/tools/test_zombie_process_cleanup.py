...
class TestAgentCloseMethod:
    ...
    def test_close_calls_cleanup_functions(self):
        ...
        with patch("opencodon.core.run_agent.AIAgent.__init__", return_value=None):
            ...
            with patch("opencodon.tools.process_registry.process_registry") as mock_registry, \
                 patch("opencodon.core.run_agent.cleanup_vm") as mock_cleanup_vm, \
                 patch("opencodon.core.run_agent.cleanup_browser") as mock_cleanup_browser:
                agent.close()
    ...
    def test_close_survives_partial_failures(self):
        ...
        with patch("opencodon.core.run_agent.AIAgent.__init__", return_value=None):
            ...
            with patch(
                ...
                "opencodon.core.run_agent.cleanup_vm"
            ) as mock_vm, patch(
                "opencodon.core.run_agent.cleanup_browser"
            ) as mock_browser:
