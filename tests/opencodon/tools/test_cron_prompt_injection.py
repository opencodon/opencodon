...
from opencodon.tools.cronjob_tools import _scan_cron_prompt
...
class TestInvisibleUnicodeParity:
    ...
    def test_cron_set_matches_canonical(self):
        ...
        from opencodon.tools.cronjob_tools import _CRON_INVISIBLE_CHARS
        from opencodon.tools.threat_patterns import INVISIBLE_CHARS
