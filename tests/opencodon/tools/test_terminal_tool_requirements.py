...
class TestTerminalRequirements:
    ...
    def test_transient_failure_after_success_is_suppressed(self, monkeypatch):
        import opencodon.tools.registry as reg
    ...
    def test_subagent_keeps_file_tools_through_docker_flake(self, monkeypatch):
        ...
        from opencodon import tools as tools_pkg
        ...
        from opencodon.tools.model_tools import get_tool_definitions, _clear_tool_defs_cache
