...
def test_text_response_surfaces_fields_additively():
    ...
    from opencodon.tools.computer_use.tool import _text_response
...
def test_dispatcher_threads_delivery_mode_to_backend():
    ...
    from opencodon.tools.computer_use import tool as cu
...
def test_foreground_summary_warns_about_focus_change():
    from opencodon.tools.computer_use.tool import _summarize_action
