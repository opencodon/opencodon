...
from opencodon.tools.skills_guard import SCANNER_VERSION, scan_skill_cached
from opencodon.tools.skills_hub import GitHubAuth, GitHubSource, HubLockFile, SkillBundle, UrlSource
...
def served_repo(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("opencodon.tools.url_safety._global_allow_private_urls", lambda: True)
