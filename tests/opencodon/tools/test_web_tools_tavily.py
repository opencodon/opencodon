...
from tests.opencodon.tools.conftest import register_all_web_providers
...
class TestTavilyRequest:
    ...
    def test_raises_without_api_key(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            from opencodon.tools.web_tools import _tavily_request
    ...
    def test_posts_with_api_key_in_body(self):
        ...
        with patch.dict(os.environ, {"TAVILY_API_KEY": "tvly-test-key"}):
            with patch("opencodon.tools.web_tools.httpx.post", return_value=mock_response) as mock_post:
                from opencodon.tools.web_tools import _tavily_request
    ...
    def test_raises_on_http_error(self):
        ...
        with patch.dict(os.environ, {"TAVILY_API_KEY": "tvly-bad-key"}):
            with patch("opencodon.tools.web_tools.httpx.post", return_value=mock_response):
                from opencodon.tools.web_tools import _tavily_request
...
class TestNormalizeTavilySearchResults:
    ...
    def test_basic_normalization(self):
        from opencodon.tools.web_tools import _normalize_tavily_search_results
        raw = {
            "results": [
...
class TestNormalizeTavilyDocuments:
    ...
    def test_basic_document(self):
        from opencodon.tools.web_tools import _normalize_tavily_documents
        raw = {
            "results": [{
...
class TestWebSearchTavily:
    ...
    def test_search_dispatches_to_tavily(self):
        ...
        with patch("opencodon.tools.web_tools._get_backend", return_value="tavily"), \
             patch.dict(os.environ, {"TAVILY_API_KEY": "tvly-test"}), \
             patch("opencodon.tools.web_tools.httpx.post", return_value=mock_response), \
             patch("opencodon.tools.interrupt.is_interrupted", return_value=False):
            from opencodon.tools.web_tools import web_search_tool
