...
class TestTerminalSchema:
    def test_schema_has_notify_on_complete(self):
        from opencodon.tools.terminal_tool import TERMINAL_SCHEMA
    ...
    def test_handler_passes_notify(self):
        ...
        from opencodon.tools.terminal_tool import _handle_terminal
        with patch("opencodon.tools.terminal_tool.terminal_tool", return_value='{"ok":true}') as mock_tt:
            _handle_terminal(
...
class TestCodeExecutionBlocked:
    def test_notify_on_complete_blocked_in_sandbox(self):
        from opencodon.tools.code_execution_tool import _TERMINAL_BLOCKED_PARAMS
...
def _silent_bg_harness(monkeypatch, tmp_path):
    ...
    import opencodon.tools.terminal_tool as terminal_tool_module
    from opencodon.tools import process_registry as process_registry_module
