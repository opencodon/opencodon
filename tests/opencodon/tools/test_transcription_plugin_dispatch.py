...
class TestTranscribeAudioE2E:
    ...
    def test_unknown_name_with_plugin_dispatches(self):
        ...
        with patch("opencodon.tools.transcription_tools._validate_audio_file", return_value=None), \
             patch("opencodon.tools.transcription_tools._load_stt_config", return_value={"provider": "openrouter"}), \
             patch("opencodon.tools.transcription_tools.is_stt_enabled", return_value=True), \
             patch("opencodon.tools.transcription_tools._get_provider", return_value="openrouter"):
    ...
    def test_builtin_name_does_not_consult_plugin_registry(self):
        ...
        with patch("opencodon.tools.transcription_tools._validate_audio_file", return_value=None), \
             patch("opencodon.tools.transcription_tools._load_stt_config", return_value={"provider": "groq"}), \
...
class TestLanguageForwardingFromConfig:
    ...
    def test_language_read_from_provider_namespaced_config(self):
        ...
        with patch("opencodon.tools.transcription_tools._validate_audio_file", return_value=None), \
             patch("opencodon.tools.transcription_tools._load_stt_config", return_value=stt_config), \
             patch("opencodon.tools.transcription_tools.is_stt_enabled", return_value=True), \
             patch("opencodon.tools.transcription_tools._get_provider", return_value="openrouter"):
