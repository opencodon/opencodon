...
from opencodon.tools.todo_tool import TodoStore, todo_tool
...
class TestTodoStoreBounds:
    ...
    def test_oversized_content_is_truncated(self):
        from opencodon.tools.todo_tool import MAX_TODO_CONTENT_CHARS
        store = TodoStore()
    ...
    def test_item_count_is_bounded(self):
        from opencodon.tools.todo_tool import MAX_TODO_ITEMS
        store = TodoStore()
        store.write([
