...
from opencodon.tools.session_search_tool import (
...
class TestCronDemotion:
    ...
    def test_order_for_recall_is_stable_within_class(self):
        from opencodon.tools.session_search_tool import _order_for_recall
        rows = [
            {"id": 1, "source": "cron"},
...
class TestCompactionSummaryFiltering:
    ...
    def test_is_compaction_summary_detects_prefix(self):
        from opencodon.tools.session_search_tool import _is_compaction_summary
