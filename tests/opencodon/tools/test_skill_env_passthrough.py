...
from opencodon.tools.env_passthrough import clear_env_passthrough, is_env_passthrough
...
class TestSkillViewRegistersPassthrough:
    def test_available_env_vars_registered(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "opencodon.tools.skills_tool.SKILLS_DIR", tmp_path
        )
        ...
        with patch("opencodon.tools.skills_tool._secret_capture_callback", None):
    ...
    def test_remote_backend_persisted_env_vars_registered(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("opencodon.tools.skills_tool.SKILLS_DIR", tmp_path)
