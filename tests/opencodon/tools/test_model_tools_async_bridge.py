...
class TestRunAsyncWorkerThread:
    ...
    def test_worker_loop_separate_from_main_loop(self):
        ...
        from concurrent.futures import ThreadPoolExecutor
        from opencodon.tools.model_tools import _run_async, _get_tool_loop
...
class TestVisionDispatchLoopSafety:
    ...
    def test_vision_dispatch_keeps_loop_alive(self, tmp_path):
        ...
        from opencodon.tools.model_tools import _get_tool_loop
        ...
        with (
            ...
            patch(
                "opencodon.tools.vision_tools._validate_image_url_async",
                new_callable=AsyncMock,
                return_value=True,
            ),
            patch(
