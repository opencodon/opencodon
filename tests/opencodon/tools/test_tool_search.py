...
class TestConfigParsing:
    def test_default_when_missing(self):
        from opencodon.tools.tool_search import ToolSearchConfig
...
class TestClassification:
    def test_core_tools_never_defer(self):
        ...
        from opencodon.tools.tool_search import is_deferrable_tool_name
        # Sample of core tools from _OPENCODON_CORE_TOOLS.
    ...
    def test_bridge_tools_never_defer(self):
        from opencodon.tools.tool_search import is_deferrable_tool_name, BRIDGE_TOOL_NAMES
    ...
    def test_classify_keeps_unknown_in_visible(self):
        ...
        """
        from opencodon.tools.tool_search import classify_tools
...
class TestThresholdGate:
    def test_off_never_activates(self):
        from opencodon.tools.tool_search import ToolSearchConfig, should_activate
    ...
    def test_token_estimate_proportional_to_schema_size(self):
        from opencodon.tools.tool_search import estimate_tokens_from_schemas
        small = [_td("a", "x")]
...
class TestRetrieval:
    def _fake_catalog(self):
        ...
        from opencodon.tools.tool_search import CatalogEntry, _tokenize, _entry_search_text
        defs = [
    ...
    def test_search_finds_relevant_tool(self):
        from opencodon.tools.tool_search import search_catalog
...
class TestAssembly:
    def test_no_deferrable_returns_unchanged(self):
        ...
        from opencodon.tools.tool_search import assemble_tool_defs, ToolSearchConfig
    ...
    def test_idempotent_when_bridge_already_present(self):
        from opencodon.tools.tool_search import assemble_tool_defs, ToolSearchConfig, BRIDGE_TOOL_NAMES
...
class TestBridgeDispatch:
    def test_tool_search_requires_query(self):
        from opencodon.tools.tool_search import dispatch_tool_search
        result = dispatch_tool_search({}, current_tool_defs=[])
        assert "error" in json.loads(result)

    def test_tool_describe_requires_name(self):
        from opencodon.tools.tool_search import dispatch_tool_describe
    ...
    def test_resolve_underlying_call_parses_object_args(self):
        from opencodon.tools.tool_search import resolve_underlying_call
    ...
    def test_resolve_underlying_call_rejects_recursion(self):
        ...
        from opencodon.tools.tool_search import resolve_underlying_call, TOOL_CALL_NAME
        name, args, err = resolve_underlying_call({
            "name": TOOL_CALL_NAME,
            "arguments": {},
        })
...
class TestRegression_OpenClawCron84141:
    ...
    def test_core_tool_survives_alongside_many_mcp_tools(self):
        from opencodon.tools.tool_search import (
...
class TestRegression_ToolsetScoping:
    ...
    def test_scoped_deferrable_names_helper(self):
        from opencodon.tools.tool_search import scoped_deferrable_names
