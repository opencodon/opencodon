...
class TestBackgroundChildDoesNotHang:
    ...
    def test_plain_background_returns_promptly(self, local_env):
        ...
        marker = "opencodon_8340_plain_bg"
    ...
    def test_foreground_capture_is_bounded_while_draining(
        ...
        monkeypatch.setattr("opencodon.tools.tool_output_limits.get_max_bytes", lambda: 10_000)
        command = (
    ...
    def test_continuous_output_still_honors_foreground_timeout(
        ...
        monkeypatch.setattr("opencodon.tools.tool_output_limits.get_max_bytes", lambda: 5_000)
        command = (
            "python3 -c \"import sys; "
            "chunk = 'x' * 4096; "
