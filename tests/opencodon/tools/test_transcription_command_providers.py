...
from opencodon.tools.transcription_tools import (
...
class TestTranscribeAudioDispatchToCommandProvider:
    ...
    OPENCODON_LOCAL_STT_COMMAND) by patching ``_load_stt_config`` directly.
    """
    ...
    def test_command_provider_dispatches_via_transcribe_audio(self, tmp_path):
        ...
        with patch("opencodon.tools.transcription_tools._load_stt_config", return_value=cfg):
...
class TestCommandWinsOverPlugin:
    ...
    def test_command_wins_when_both_configured(self, tmp_path):
        ...
        from opencodon.core.media.transcription_registry import (
            _reset_for_tests,
            register_provider,
        )
