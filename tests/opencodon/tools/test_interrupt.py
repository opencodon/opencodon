...
class TestInterruptModule:
    ...
    def test_set_and_check(self):
        from opencodon.tools.interrupt import set_interrupt, is_interrupted
        set_interrupt(False)
    ...
    def test_thread_safety(self):
        ...
        from opencodon.tools.interrupt import set_interrupt, is_interrupted, _interrupted_threads, _lock
        set_interrupt(False)
...
1. CLI: Run `opencodon`, ask it to `sleep 30` in terminal, type "stop" + Enter.
