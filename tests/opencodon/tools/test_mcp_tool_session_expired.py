...
def test_is_session_expired_detects_invalid_or_expired_session():
    ...
    from opencodon.tools.mcp_tool import _is_session_expired_error
...
def test_call_tool_handler_rebuilds_configured_server_transport(
    ...
    from anyio import ClosedResourceError
    from opencodon.tools import mcp_tool
    from opencodon.tools.mcp_tool import MCPServerTask, _make_tool_handler
...
def test_call_tool_handler_reconnects_on_session_expired(monkeypatch, tmp_path):
    ...
    from opencodon.tools import mcp_tool
    from opencodon.tools.mcp_tool import _make_tool_handler
...
def test_session_expired_handler_returns_none_without_loop(monkeypatch):
    ...
    or raising."""
    from opencodon.tools import mcp_tool
    from opencodon.tools.mcp_tool import _handle_session_expired_and_retry
