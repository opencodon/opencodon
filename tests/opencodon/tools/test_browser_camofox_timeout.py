...
class TestCamofoxCommandTimeout:
    ...
    def test_default_is_30(self):
        ...
        from opencodon.tools.browser_camofox import _get_command_timeout
        ...
        with patch("opencodon.tools.browser_camofox.read_raw_config", return_value={}):
    ...
    def test_reads_from_config(self):
        ...
        with patch("opencodon.tools.browser_camofox.read_raw_config", return_value=cfg):
    ...
    def test_cached_after_first_call(self):
        ...
        with patch("opencodon.tools.browser_camofox.read_raw_config", mock_read):
    ...
    def test_config_read_error_falls_back(self):
        ...
        with patch("opencodon.tools.browser_camofox.read_raw_config", side_effect=Exception("no config")):
            assert _get_command_timeout() == 30
