...
fetches one page per call, so opencodon must follow the cursor to see items
...
from opencodon.tools.mcp_tool import _MCP_LIST_MAX_PAGES, _paginate_full_list
