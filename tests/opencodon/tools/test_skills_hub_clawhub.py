...
from opencodon.tools.skills_hub import ClawHubSource, SkillMeta
...
class TestClawHubSource(unittest.TestCase):
    def setUp(self):
        ...
        self._safe_patcher = patch("opencodon.tools.skills_hub.is_safe_url", return_value=True)
        self._policy_patcher = patch("opencodon.tools.skills_hub.check_website_access", return_value=None)
    ...
    @patch("opencodon.tools.skills_hub.is_safe_url")
    @patch("opencodon.tools.skills_hub.httpx.get")
    @patch("opencodon.tools.skills_hub._ssrf_safe_http_get")
