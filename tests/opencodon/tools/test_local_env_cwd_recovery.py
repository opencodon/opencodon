...
Regression coverage for upstream#17558
"""
    ...
    def test_recovers_when_cwd_deleted_after_init(self, tmp_path, caplog):
        ...
        try:
            with patch("opencodon.tools.environments.local._find_bash", return_value="/bin/bash"), \
                 ...
                 patch("opencodon.tools.terminal_tool._interrupt_event", _fake_interrupt()), \
                 caplog.at_level("WARNING", logger="opencodon.tools.environments.local"):
