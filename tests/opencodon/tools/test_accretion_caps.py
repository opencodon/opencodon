...
class TestReadTrackerCaps:
    def setup_method(self):
        from opencodon.tools import file_tools
    ...
    def test_read_history_capped(self, monkeypatch):
        ...
        from opencodon.tools import file_tools as ft
...
class TestCompletionConsumedPrune:
    def test_prune_drops_completion_entry_with_expired_session(self):
        ...
        from opencodon.tools.process_registry import ProcessRegistry, FINISHED_TTL_SECONDS
        import time
