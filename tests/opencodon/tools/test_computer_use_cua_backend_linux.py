...
def test_parse_xprop_net_active_window_standard_output():
    from opencodon.tools.computer_use.cua_backend import _parse_xprop_net_active_window
...
def test_default_capture_prefers_x11_active_window_when_z_index_tied():
    from opencodon.tools.computer_use.cua_backend import _select_capture_target

    windows = _normalized_windows()

    with patch("opencodon.tools.computer_use.cua_backend.sys.platform", "linux"), patch(
        "opencodon.tools.computer_use.cua_backend._linux_x11_active_window_id",
