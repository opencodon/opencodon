...
class TestExtractRelevantContentNoneGuard:
    ...
    def test_none_content_falls_back_to_truncated(self):
        ...
        with patch("opencodon.tools.browser_tool.call_llm", return_value=_make_response(None)), \
             patch("opencodon.tools.browser_tool._get_extraction_model", return_value="test-model"):
    ...
    def test_normal_content_returned(self):
        ...
        with patch("opencodon.tools.browser_tool.call_llm", return_value=_make_response("Extracted content here")), \
             patch("opencodon.tools.browser_tool._get_extraction_model", return_value="test-model"):
            from opencodon.tools.browser_tool import _extract_relevant_content
    ...
    def test_empty_string_content_falls_back(self):
        ...
        with patch("opencodon.tools.browser_tool.call_llm", return_value=_make_response("   ")), \
             patch("opencodon.tools.browser_tool._get_extraction_model", return_value="test-model"):
            from opencodon.tools.browser_tool import _extract_relevant_content
