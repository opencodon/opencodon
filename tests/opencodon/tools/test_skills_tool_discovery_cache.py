...
opencodon_cli/profiles.py::_count_skills) plus the disabled-set, with a short
...
import opencodon.tools.skills_tool as st
...
def _fresh_cache(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "opencodon.core.skills.skill_utils.get_external_skills_dirs", lambda: []
    )
