...
These exercise the dispatch logic in ``opencodon.tools.browser_tool._browser_eval`` and
...
# ---------------------------------------------------------------------------
# Fast-path dispatch: opencodon.tools.browser_tool._browser_eval
# ---------------------------------------------------------------------------
...
def _patch_supervisor(monkeypatch, supervisor):
    ...
    import opencodon.tools.browser_supervisor as bs
