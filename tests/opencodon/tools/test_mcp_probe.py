"""Tests for probe_mcp_server_tools() in opencodon.tools.mcp_tool."""
...
class TestProbeMcpServerTools:
    ...
    def test_returns_empty_when_no_config(self):
        with patch("opencodon.tools.mcp_tool._load_mcp_config", return_value={}):
            from opencodon.tools.mcp_tool import probe_mcp_server_tools
            result = probe_mcp_server_tools()
        assert result == {}
    ...
    def test_returns_empty_when_all_servers_disabled(self):
        ...
        with patch("opencodon.tools.mcp_tool._load_mcp_config", return_value=config):
            from opencodon.tools.mcp_tool import probe_mcp_server_tools
            result = probe_mcp_server_tools()
        assert result == {}
    ...
    def test_returns_tools_from_successful_server(self):
        ...
        with patch("opencodon.tools.mcp_tool._MCP_AVAILABLE", True), \
             patch("opencodon.tools.mcp_tool._load_mcp_config", return_value=config), \
             patch("opencodon.tools.mcp_tool._connect_server", side_effect=fake_connect), \
             patch("opencodon.tools.mcp_tool._ensure_mcp_loop"), \
             patch("opencodon.tools.mcp_tool._run_on_mcp_loop") as mock_run, \
             patch("opencodon.tools.mcp_tool._stop_mcp_loop"):
    ...
    def test_cleanup_called_even_on_failure(self):
        ...
        with patch("opencodon.tools.mcp_tool._MCP_AVAILABLE", True), \
             patch("opencodon.tools.mcp_tool._load_mcp_config", return_value=config), \
             patch("opencodon.tools.mcp_tool._ensure_mcp_loop"), \
             patch("opencodon.tools.mcp_tool._run_on_mcp_loop", side_effect=RuntimeError("boom")), \
             patch("opencodon.tools.mcp_tool._stop_mcp_loop_if_idle") as mock_stop:
