...
class TestExplicitAuxVisionOverride:
    ...
    def test_returns_false_for_none_cfg(self):
        from opencodon.tools.computer_use.vision_routing import _explicit_aux_vision_override
...
class TestRouteDecision:
    ...
    def test_explicit_override_routes_to_aux_even_for_vision_main(self):
        ...
        """
        from opencodon.tools.computer_use import vision_routing
...
class TestLookupHelpers:
    def test_lookup_supports_vision_returns_none_for_blank_provider(self):
        from opencodon.tools.computer_use.vision_routing import _lookup_supports_vision
    ...
    def test_lookup_supports_vision_handles_lookup_exception(self):
        ...
        with patch("opencodon.core.providers.models_dev.get_model_capabilities", side_effect=_boom):
