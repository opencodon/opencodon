...
downstream consumers (CI / `opencodon update`) rely on:
...
opencodon-side adapter behaves correctly against the documented response
shape.
"""
...
# ── OPENCODON_CUA_DRIVER_CMD resolution ───────────────────────────────────────
