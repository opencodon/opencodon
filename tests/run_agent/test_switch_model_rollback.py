...
def test_openai_client_rebuild_failure_rolls_back_to_original_state():
    ...
    with patch("opencodon_cli.timeouts.get_provider_request_timeout", return_value=None):
...
def test_anthropic_client_rebuild_failure_rolls_back_to_original_state():
    ...
    with (
        ...
        patch("opencodon_cli.timeouts.get_provider_request_timeout", return_value=None),
    ):
