...
The unit tests in tests/opencodon_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned opencodon-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/opencodon")
