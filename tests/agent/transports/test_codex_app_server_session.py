...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_opencodon_tools_auto_accepts(self):
        """When codex elicits on behalf of opencodon-tools (our own callback),
