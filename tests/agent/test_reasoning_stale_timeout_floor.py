...
thinking phase.  opencodon's default cloud-stream stale detector
(``OPENCODON_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``OPENCODON_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
