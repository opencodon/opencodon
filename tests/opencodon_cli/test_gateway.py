...
def test_s6_runtime_snapshot_reports_supervised_service(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("opencodon_cli.service_manager.detect_service_manager", lambda: "s6")
    monkeypatch.setattr("opencodon_cli.service_manager.get_service_manager", lambda: FakeS6Manager())
...
def test_module_has_logger():
    ...
    assert gateway.logger.name == "opencodon_cli.gateway"
