...
class TestCustomProviderModelSwitch:
    ...
    def test_custom_endpoint_switch_prunes_stale_model_config_pool_entry(
        ...
        with patch(
            "opencodon_cli.models.probe_api_models",
            return_value={
                "models": ["new-model"],
                "used_fallback": False,
             ...
             patch("opencodon_cli.secret_prompt.masked_secret_prompt", return_value="sk-new"), \
             patch("opencodon_cli.main._prompt_custom_api_mode_selection", return_value=""), \
             patch(
                 "builtins.input",
                 side_effect=[
    ...
    def test_saved_model_still_probes_endpoint(self, config_home):
        ...
        with patch("opencodon_cli.models.fetch_api_models", return_value=["model-A", "model-B"]) as mock_fetch, \
             patch("opencodon_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
    ...
    def test_can_switch_to_different_model(self, config_home):
        ...
        with patch("opencodon_cli.models.fetch_api_models", return_value=["model-A", "model-B"]), \
             patch("opencodon_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="2"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_probe_failure_falls_back_to_saved(self, config_home):
        ...
        with patch("opencodon_cli.models.fetch_api_models", return_value=[]), \
    ...
    def test_no_saved_model_still_works(self, config_home):
        ...
        with patch("opencodon_cli.models.fetch_api_models", return_value=["model-X"]), \
             patch("opencodon_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
    ...
    def test_api_mode_set_from_provider_info(self, config_home):
        ...
        with patch("opencodon_cli.models.fetch_api_models", return_value=["claude-3"]) as mock_fetch, \
             patch("opencodon_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_api_mode_cleared_when_not_specified(self, config_home):
        ...
        with patch("opencodon_cli.models.fetch_api_models", return_value=["llama-3"]), \
             patch("opencodon_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_env_template_api_key_is_preserved_in_model_config(self, config_home, monkeypatch):
        ...
        with patch("opencodon_cli.models.fetch_api_models", return_value=["qwen3.6-35b-fast"]) as mock_fetch, \
             patch("opencodon_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_key_env_custom_provider_persists_reference_not_secret(self, config_home, monkeypatch):
        ...
        with patch("opencodon_cli.models.fetch_api_models", return_value=["qwen3.6-35b-fast"]), \
             patch("opencodon_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_env_ref_base_url_preserves_api_key_ref_through_picker(
        ...
        with patch("opencodon_cli.main._prompt_provider_choice",
                   side_effect=_pick_neuralwatt), \
             patch("opencodon_cli.models.fetch_api_models",
...
class TestCustomProviderDiscoverModels:
    ...
    def test_discover_false_uses_configured_list_and_skips_probe(self, config_home):
        ...
        with patch("opencodon_cli.models.fetch_api_models") as mock_fetch, \
             patch("opencodon_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="2"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
