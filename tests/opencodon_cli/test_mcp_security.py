...
def test_mcp_add_rejects_dangerous_entry_before_probe(monkeypatch, capsys):
    ...
    monkeypatch.setattr("opencodon_cli.mcp_config._probe_single_server", _probe_should_not_run)
...
def test_dashboard_mcp_add_rejects_dangerous_entry():
    ...
    from opencodon_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN, app
