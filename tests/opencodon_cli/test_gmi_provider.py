...
class TestGmiAliases:
    ...
    def test_providers_normalize_provider(self):
        from opencodon_cli.providers import normalize_provider as normalize_provider_in_providers
...
class TestGmiModelCatalog:
    ...
    def test_provider_model_ids_falls_back_to_static_models(self, monkeypatch):
        ...
        monkeypatch.setattr("opencodon_cli.models.fetch_api_models", lambda api_key, base_url: None)
...
class TestGmiMainFlow:
    ...
    def test_select_provider_and_model_routes_gmi_to_generic_flow(self, monkeypatch):
        ...
        monkeypatch.setattr("opencodon_cli.auth.resolve_provider", lambda *args, **kwargs: None)
        ...
        monkeypatch.setattr("opencodon_cli.main._model_flow_api_key_provider", fake_model_flow_api_key_provider)
