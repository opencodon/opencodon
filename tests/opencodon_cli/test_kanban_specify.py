"""Tests for the specifier module + `opencodon kanban specify` CLI surface.
...
from opencodon_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `opencodon kanban …` argparse surface directly."""
