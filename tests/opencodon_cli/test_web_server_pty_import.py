...
def test_web_server_uses_win_pty_bridge_on_windows():
    ...
    from opencodon_cli.win_pty_bridge import WinPtyBridge
    ...
    from opencodon_cli.win_pty_bridge import PtyUnavailableError as WinErr
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from opencodon_cli.pty_bridge import PtyBridge as PosixBridge
    from opencodon_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    assert "from opencodon_cli.win_pty_bridge import" in src
    assert "from opencodon_cli.pty_bridge import" in src
