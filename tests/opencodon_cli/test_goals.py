...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from opencodon_cli.goals import _parse_judge_response
...
class TestJudgeGoal:
    def test_empty_goal_skipped(self):
        from opencodon_cli.goals import judge_goal
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from opencodon_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, opencodon_home):
        ...
        from opencodon_cli import goals
        from opencodon_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from opencodon_cli import goals
        from opencodon_cli.goals import GoalManager, load_goal
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        from opencodon_cli.goals import GoalState
...
class TestMigrateGoalToSession:
    ...
    def test_migrates_active_goal_to_child(self, opencodon_home):
        from opencodon_cli.goals import save_goal, load_goal, migrate_goal_to_session, GoalState
    ...
    def test_no_goal_to_migrate_returns_false(self, opencodon_home):
        from opencodon_cli.goals import migrate_goal_to_session, load_goal
    ...
    def test_same_id_is_noop(self, opencodon_home):
        from opencodon_cli.goals import save_goal, migrate_goal_to_session, GoalState
    ...
    def test_cleared_goal_not_migrated(self, opencodon_home):
        from opencodon_cli.goals import save_goal, clear_goal, migrate_goal_to_session, load_goal, GoalState
...
class TestParseContract:
    def test_plain_goal_no_contract(self):
        from opencodon_cli.goals import parse_contract
...
class TestGoalContractSerialization:
    def test_roundtrip_with_contract(self):
        from opencodon_cli.goals import GoalState, GoalContract
...
class TestGoalManagerContract:
    def test_set_with_contract(self, opencodon_home):
        from opencodon_cli.goals import GoalManager, GoalContract
    ...
    def test_set_contract_after_the_fact(self, opencodon_home):
        ...
        assert mgr.has_contract()
        # Survives reload.
        from opencodon_cli.goals import GoalManager as GM2
