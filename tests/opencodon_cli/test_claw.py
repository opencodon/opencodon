...
from opencodon_cli import claw as claw_mod
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.opencodon/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.opencodon/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.opencodon/migration/openclaw/20250312T120000",
        }
