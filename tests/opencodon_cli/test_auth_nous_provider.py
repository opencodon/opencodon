...
from opencodon_cli.auth import AuthError, get_provider_auth_state, resolve_nous_runtime_credentials
...
def test_resolve_nous_runtime_credentials_env_override_wins_live_not_persisted(
    ...
    monkeypatch.setattr("opencodon_cli.auth._refresh_access_token", _fake_refresh_access_token)
...
def test_nous_inference_auth_logs_do_not_include_secret_values(
    ...
    caplog.set_level(logging.INFO, logger="opencodon_cli.auth")
    auth_mod.resolve_nous_runtime_credentials(
        force_refresh=True,
    )
...
def test_get_nous_auth_status_reports_revoked_refresh_session(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("opencodon_cli.auth.resolve_nous_runtime_credentials", _boom)
...
def test_refresh_token_reuse_detection_surfaces_actionable_message():
    ...
    """
    from opencodon_cli.auth import _refresh_access_token
...
def test_shared_store_read_missing_returns_none(shared_store_env):
    ...
    from opencodon_cli.auth import _read_shared_nous_state
...
def test_shared_store_read_malformed_returns_none(shared_store_env):
    ...
    from opencodon_cli.auth import _nous_shared_store_path, _read_shared_nous_state
...
def test_shared_store_write_skips_when_refresh_token_missing(shared_store_env):
    ...
    from opencodon_cli.auth import _nous_shared_store_path, _write_shared_nous_state
...
def test_try_import_shared_returns_none_when_store_missing(shared_store_env):
    ...
    from opencodon_cli.auth import _try_import_shared_nous_state
