"""Tests for opencodon_cli.model_catalog — remote manifest fetch + cache + fallback."""
...
class TestValidation:
    def test_accepts_well_formed_manifest(self, isolated_home):
        from opencodon_cli.model_catalog import _validate_manifest
...
class TestDefaultModelFromCache:
    ...
    def test_shipped_manifest_labels_glm52_default(self, isolated_home):
        ...
        import opencodon_cli.model_catalog as model_catalog
        from opencodon_cli.models import PREFERRED_SILENT_DEFAULT_MODEL
