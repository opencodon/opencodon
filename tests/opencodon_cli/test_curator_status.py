"""Tests for `opencodon curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated OPENCODON_HOME with real agent-created skills on disk."""
    ...
    from opencodon_cli import curator as curator_cli
