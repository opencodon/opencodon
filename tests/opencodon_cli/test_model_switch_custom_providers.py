...
import opencodon_cli.providers as providers_mod
import pytest
...
def _disable_live_custom_provider_model_probe(monkeypatch):
    ...
    monkeypatch.setattr("opencodon_cli.models.fetch_api_models", lambda *_a, **_kw: None)
...
def test_list_authenticated_providers_includes_custom_providers(monkeypatch):
    ...
    monkeypatch.setattr("opencodon_cli.models.fetch_api_models", lambda *a, **k: [])
...
def test_list_authenticated_providers_can_skip_custom_provider_live_probe(monkeypatch):
    ...
    monkeypatch.setattr("opencodon_cli.models.fetch_api_models", fetch)
...
def test_switch_model_accepts_explicit_bare_custom_current_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("opencodon_cli.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
    monkeypatch.setattr("opencodon_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("opencodon_cli.model_switch.get_model_capabilities", lambda *a, **k: None)
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("opencodon_cli.models.fetch_lmstudio_models", _fake_fetch)
...
def test_resolve_custom_provider_passes_key_env():
    ...
    """
    from opencodon_cli.providers import resolve_custom_provider
...
def test_discovered_models_auto_saved_to_cache(monkeypatch):
    ...
    monkeypatch.setattr("opencodon_cli.models.fetch_api_models", fake_fetch_api_models)
    monkeypatch.setattr(
        "opencodon_cli.model_switch._save_discovered_models_to_config",
...
def test_save_discovered_models_skips_unchanged(monkeypatch):
    ...
    from opencodon_cli.model_switch import _save_discovered_models_to_config
