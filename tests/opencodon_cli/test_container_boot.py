...
from opencodon_cli.container_boot import (
    ReconcileAction,
...
def _hermetic_container_argv(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    """
    monkeypatch.setattr(
        "opencodon_cli.container_boot._read_container_argv",
        lambda: (),
    )
...
def test_reconcile_log_rotates_when_size_exceeded(
    ...
    from opencodon_cli import container_boot
...
def test_is_dashboard_container_true_for_dashboard_argv(
    ...
    from opencodon_cli.container_boot import _is_dashboard_container
