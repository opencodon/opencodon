...
appear in ``/model`` without a opencodon release.
"""
...
class TestProviderModelIdsPreferred:
    ...
    def test_k3_live_discovery_is_scoped_to_kimi_coding_endpoint(self):
        ...
        with patch("opencodon_cli.urllib_security.open_credentialed_url", side_effect=fake_open):
            with patch(
                "opencodon_cli.auth.resolve_api_key_provider_credentials",
                return_value={
    ...
    def test_kimi_setup_flow_uses_same_coding_plan_catalog(self):
        ...
        from opencodon_cli.model_setup_flows import _model_flow_kimi
...
class TestOpenRouterAndNousUnchanged:
    ...
    def test_openrouter_does_not_call_merge(self):
        ...
        with patch(
            "opencodon_cli.models._merge_with_models_dev",
