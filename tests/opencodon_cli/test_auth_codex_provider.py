"""Tests for Codex auth — tokens stored in Hermes auth store (~/.opencodon/auth.json)."""
...
def _setup_hermes_auth(opencodon_home: Path, *, access_token: str = "access", refresh_token: str = "refresh"):
...
def test_read_codex_tokens_success(tmp_path, monkeypatch):
    ...
    _setup_hermes_auth(opencodon_home)
...
def test_resolve_codex_runtime_credentials_refreshes_expiring_token(tmp_path, monkeypatch):
    ...
    _setup_hermes_auth(opencodon_home, access_token=expiring_token, refresh_token="refresh-old")
    monkeypatch.setenv("OPENCODON_HOME", str(opencodon_home))
...
def test_resolve_codex_runtime_credentials_force_refresh(tmp_path, monkeypatch):
    opencodon_home = tmp_path / "hermes"
    _setup_hermes_auth(opencodon_home, access_token="access-current", refresh_token="refresh-old")
    monkeypatch.setenv("OPENCODON_HOME", str(opencodon_home))
