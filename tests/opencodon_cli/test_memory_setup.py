...
import opencodon_cli.memory_setup as memory_setup
from opencodon_cli.memory_setup import _CANCELLED, _curses_select
...
def test_curses_select_cancel_defaults_to_selected(monkeypatch):
    ...
    monkeypatch.setattr("opencodon_cli.curses_ui.curses_radiolist", fake_radiolist)
