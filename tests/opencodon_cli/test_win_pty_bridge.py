...
from opencodon_cli.win_pty_bridge import PtyUnavailableError, WinPtyBridge
...
class TestClampDimension:
    ...
    def test_clamps_above_max(self):
        from opencodon_cli.win_pty_bridge import _MAX_COLS, _MAX_ROWS, _clamp

        assert _clamp(131072, _MAX_COLS) == _MAX_COLS
        assert _clamp(131072, _MAX_ROWS) == _MAX_ROWS

    def test_floors_at_one(self):
        from opencodon_cli.win_pty_bridge import _MAX_COLS, _clamp
