    ...
    def test_bare_setup_runs_full_reconfigure_without_menu(self, existing_install):
        ...
        with ExitStack() as stack:
            m = _enter_existing_install_patches(
                stack,
                prompt_choice="opencodon_cli.setup.prompt_choice",
                quick="opencodon_cli.setup._run_quick_setup",
                model="opencodon_cli.setup.setup_model_provider",
                terminal="opencodon_cli.setup.setup_terminal_backend",
                agent="opencodon_cli.setup.setup_agent_settings",
                gateway="opencodon_cli.setup.setup_gateway",
                tools="opencodon_cli.setup.setup_tools",
            )
    ...
    def test_bare_setup_runs_first_time_flow(self, fresh_install):
        ...
        with ExitStack() as stack:
            m = _enter_fresh_install_patches(
                stack,
                prompt=("opencodon_cli.setup.prompt_choice", {"return_value": 0}),
                first="opencodon_cli.setup._run_first_time_quick_setup",
            )
            from opencodon_cli.setup import run_setup_wizard
            run_setup_wizard(args)
