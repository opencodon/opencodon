...
Run from the PR worktree:
    ...
    cd ~/.opencodon/opencodon/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.opencodon/opencodon``.
...
# Isolated OPENCODON_HOME for the config write.
