...
class TestBundledPluginsRegister:
    ...
    def test_all_three_plugins_present_in_registry(self) -> None:
        ...
        from opencodon.core.providers.browser_registry import list_providers
    ...
    def test_each_plugin_has_name_and_display_name(
        ...
        _ensure_plugins_loaded()
        from opencodon.core.providers.browser_registry import get_provider
...
class TestRegistryResolution:
    ...
    def test_resolve_none_with_no_creds_returns_none(self) -> None:
        ...
        _ensure_plugins_loaded()
        from opencodon.core.providers.browser_registry import _resolve
...
class TestPickerIntegration:
    ...
    def test_picker_rows_match_registered_plugins(self) -> None:
        _ensure_plugins_loaded()
        from opencodon.frontends.cli.tools_config import _plugin_browser_providers
