...
def _reset_last_init_error():
    ...
    opencodon_state._set_last_init_error(None)
    yield
    opencodon_state._set_last_init_error(None)
...
def _reset_wal_fallback_warned_paths():
    ...
    opencodon_state._wal_fallback_warned_paths.clear()
    yield
    opencodon_state._wal_fallback_warned_paths.clear()
...
class TestGetLastInitError:
    ...
    def test_success_does_not_clear_prior_error(self, tmp_path):
        ...
        """
        opencodon_state._set_last_init_error("OperationalError: locking protocol")
...
class TestFormatSessionDbUnavailable:
    ...
    def test_includes_cause(self):
        ...
        opencodon_state._set_last_init_error("OperationalError: generic SQLite error")
