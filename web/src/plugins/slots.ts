 ...
 * `window.__OPENCODON_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Opencodon brand in the top bar
 ...
 *  `window.__OPENCODON_PLUGINS__.registerSlot(...)`.
 *
