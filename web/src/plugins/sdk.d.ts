 ...
 * ``window.__OPENCODON_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__OPENCODON_PLUGIN_SDK__`` because:
 ...
 * of calling ``fetch`` with a hand-read ``window.__OPENCODON_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__OPENCODON_PLUGINS__)
// ---------------------------------------------------------------------------
