 ...
 *
 * Plugins call window.__OPENCODON_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__OPENCODON_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__OPENCODON_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__OPENCODON_PLUGIN_SDK__ = {
    ...
    // window.__OPENCODON_SESSION_TOKEN__ directly.
    authedFetch,
