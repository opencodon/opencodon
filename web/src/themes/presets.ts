 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `opencodon_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Opencodon Teal",
  description: "Classic dark teal — the canonical Opencodon look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Opencodon Teal (Large)",
  description: "Opencodon Teal with bigger fonts and roomier spacing",
