...
const STORAGE_KEY = "opencodon-dashboard-theme";
...
const FONT_STORAGE_KEY = "opencodon-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `opencodon_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "opencodon-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-opencodon-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-opencodon-theme-font", "true");
