...
export const OPENCODON_DOCS_URL = "https://github.com/opencodon/opencodon#readme";
...
export default function DocsPage() {
  ...
  return (
    ...
    >
      ...
      {/* Docs live on GitHub for now (github.com refuses framing, so no
          iframe until the project has its own docs site). */}
      <div
        className={cn(
      ...
      >
        <p className="max-w-md text-center opacity-80">
          {t.app.nav.documentation} — README, install guide, and science
          quickstart live in the opencodon repository.
        </p>
        <a
          href={OPENCODON_DOCS_URL}
          target="_blank"
