 ...
 *
 * Values mirror opencodon_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Opencodon default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Opencodon' default when unset). */
