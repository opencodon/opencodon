...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `opencodon backup`
"""
...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "opencodon").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'opencodon memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], opencodon_home: str) -> None:
        ...
        Called by 'opencodon memory setup' after collecting user inputs.
    ...
    def backup_paths(self) -> List[str]:
        ...
        ``opencodon backup`` only walks OPENCODON_HOME, so any provider state kept
        outside OPENCODON_HOME is lost
        ...
        of the archive, and ``opencodon import`` restores them to their original
