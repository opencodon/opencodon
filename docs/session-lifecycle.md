...
Counts consecutive restarts via a JSON file (`{OPENCODON_HOME}/restart_counts.json`). If a
...
This prevents unwanted auto-resets after `opencodon update`, `opencodon gateway restart`,
or `/restart`.
