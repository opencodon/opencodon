"""Compatibility shim — the real module is ``opencodon.common.constants``.
...
state stay coherent. New code must import from ``opencodon.common.constants``.
Deleted in Phase 5.
"""

import sys

import opencodon.common.constants as _real
