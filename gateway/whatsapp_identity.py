...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$OPENCODON_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_opencodon_dir("platforms/whatsapp/session", "whatsapp/session")
