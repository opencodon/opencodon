...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_kanban_command(self, event: MessageEvent) -> str:
        ...
        import re
        import shlex
        from opencodon_cli.kanban import run_slash
    ...
    async def _handle_help_command(self, event: MessageEvent) -> str:
        ...
        from opencodon_cli.commands import gateway_help_lines
        lines = [
            ...
            if has_picker:
                ...
                if providers:
                    ...
                    async def _on_model_selected_scoped(
                        ...
                        try:
                            from opencodon_cli.context_switch_guard import (
    ...
    async def _handle_goal_command(self, event: "MessageEvent") -> str:
        ...
        if lower.startswith("draft"):
            ...
            try:
                import asyncio
                from opencodon_cli.goals import draft_contract
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _opencodon_home, _resolve_opencodon_bin
        import json
        import shutil
        import subprocess
        from datetime import datetime
