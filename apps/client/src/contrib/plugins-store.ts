 ...
 * `<opencodon home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'opencodon.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'opencodon.desktop.disabledPlugins.v1'
