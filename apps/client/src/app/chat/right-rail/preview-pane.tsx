        ...
        <>
          <a
            ...
            onClick={event => {
              ...
              void window.opencodonDesktop?.openExternal(error.url)
            }}
          >
...
export function PreviewPane({
  ...
  const restartServer = useCallback(async () => {
    ...
    // "Ask Opencodon to restart the server" looked like it did nothing —
  ...
  useEffect(() => {
    if (
      ...
      !window.opencodonDesktop?.watchPreviewFile ||
      !window.opencodonDesktop?.onPreviewFileChanged
    ) {
      return
    }
    ...
    const unsubscribe = window.opencodonDesktop.onPreviewFileChanged(payload => {
    ...
    void window.opencodonDesktop
      ...
      .then(watch => {
        if (!active) {
          void window.opencodonDesktop?.stopPreviewFileWatch?.(watch.id)
    ...
    return () => {
      ...
      if (watchId) {
        void window.opencodonDesktop?.stopPreviewFileWatch?.(watchId)
      }
    }
  ...
  useEffect(() => {
    ...
    webview.setAttribute('partition', 'persist:opencodon-preview')
