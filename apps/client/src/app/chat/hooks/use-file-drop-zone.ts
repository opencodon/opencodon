...
import { type DroppedFile, extractDroppedFiles, OPENCODON_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, OPENCODON_PATHS_MIME) ? 'files' : null
