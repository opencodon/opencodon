...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  },
  {
    id: 'science',
    label: '',
    icon: props => <Codicon name="beaker" {...props} />,
    route: SCIENCE_ROUTE,
    keybindActionId: 'nav.science'
  }
]
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('opencodon:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('opencodon:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Opencodon to
