...
const TAKEOVER_KEY = 'opencodon.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Opencodon can't clear via the API — the user
 *  sees exactly what runs instead of Opencodon silently deleting their creds. */
