...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/opencodon'
...
// / Program Files), which buried any files Opencodon wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.opencodonDesktop` is
    ...
    const settings = window.opencodonDesktop?.settings
