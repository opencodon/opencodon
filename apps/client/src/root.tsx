 ...
 *
 * This package is host-agnostic: it renders against whatever
 * `window.opencodonDesktop` bridge is already installed, and never installs
...
export function mount(): void {
  ...
  // explicitly opted in (VITE_PERF_PROBE=1) — this lets the perf harness
  // measure a real, minified production renderer for representative absolute
  // numbers. A normal build leaves the flag unset, so it never reaches users.
