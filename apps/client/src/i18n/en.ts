...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteDesc: 'Connect this desktop shell to a remote Opencodon backend.',
      ...
      restartingMessage: 'Opencodon Desktop will reconnect using the saved settings — the shell stays open.',
      ...
      sshErrNotInstalled:
        'Opencodon is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bash) or set the Opencodon path.',
      sshErrPlatform:
  ...
  science: {
    ...
    refresh: 'Refresh',
    loading: 'Reading the execution record',
    tabFrames: 'Runs',
    tabArtifacts: 'Artifacts',
    trace: 'Trace',
    failedLoad: 'The execution record could not be read',
    noFramesTitle: 'No recorded runs yet',
    noFramesDesc: 'A run appears here once a session executes code. Each one keeps its cells, outputs, and the environment they ran in.',
    noArtifactsTitle: 'No artifacts yet',
    noArtifactsDesc: 'Files a session produces are recorded here with every version and the cell that wrote them.',
    cells: 'cells',
    artifacts: 'artifacts',
    failed: 'failed',
    clean: 'ran clean',
    partial: 'some cells failed',
    unknown: 'no cells recorded',
    versions: 'Versions',
    version: 'Version',
    lineage: 'Lineage',
    upstream: 'Inputs',
    ...
    download: 'Download',
    export: 'Export as RO-Crate',
    reproduce: 'Reproduce',
    reproducing: 'Replaying the recorded cells',
    reproduceGated: 'Reproduction runs only on a loopback bind',
    noLineage: 'Nothing recorded upstream or downstream of this version.',
    binaryContent: 'Binary content — download to view.',
    truncated: 'Preview truncated.',
    sessionMissing: 'The session record was pruned; the execution log survived.',
    selectPrompt: 'Select a run or artifact to see how it was produced.',
    checksum: 'Checksum',
    size: 'Size',
    created: 'Created',
    ranIn: 'Ran in'
  ...
  rightSidebar: {
    ...
    artifactsNoSessionTitle: 'No session selected',
    artifactsNoSessionDesc: 'Open a session to see what it staged.',
    artifactsEmptyTitle: 'Nothing staged yet',
    artifactsEmptyDesc: 'Files this session stages as results appear here, with their versions.',
    artifactsFailedTitle: 'Artifacts unavailable',
    artifactsFailedDesc: 'The execution record could not be read.',
    computeTitle: 'Compute',
    computeCpu: 'CPU',
    computeMemory: 'Memory',
    computeCores: (n: number) => `${n} cores`,
    computeRunning: (n: number) => `${n} running`,
    computeNoneRunning: 'idle',
    computeAlive: 'live',
    computeDead: 'dead',
    computeEmptyTitle: 'No live kernels',
    computeEmptyDesc: 'Kernels appear here once a session in this backend runs code.',
    computeUnavailable: 'Compute stats are unavailable.',
    aria: 'Right sidebar',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Opencodon will only show the first 512 KB.`,
