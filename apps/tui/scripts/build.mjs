...
await build({
  ...
  // Skip the prebuilt @opencodon/ink bundle and inline the source instead:
  ...
  alias: { '@opencodon/ink': resolve(root, 'packages/opencodon-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The opencodon_cli launcher
