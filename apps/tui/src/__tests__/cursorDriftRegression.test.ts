 ...
 *
 * Symptom: in `opencodon --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@opencodon/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using opencodon --tui and as i type multiline my caret at the end will often ' +
