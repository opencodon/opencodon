...
/**
 * E2E smoke tests for the packaged Opencodon desktop app.
 *
 ...
 * (credential stripping, isolated OPENCODON_HOME + userData, unique app name).
 *
...
test('window opens with the Opencodon title', async () => {
