...
cd apps/desktop
XCURSOR_SIZE=24 OPENCODON_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/opencodon-typing
# → /tmp/opencodon-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/opencodon-typing.before.heapsnapshot
# → /tmp/opencodon-typing.after.heapsnapshot
```
