import type { OpencodonReviewFile } from '@/global'
...
export function buildReviewFlatList(files: OpencodonReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: OpencodonReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
