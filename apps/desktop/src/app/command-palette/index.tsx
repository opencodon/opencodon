...
// Opencodon session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getOpencodonConfigRecord,
    enabled: open
  })
    ...
    return [
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          {
            icon: Download,
            id: 'cc-update-opencodon',
            keywords: ['update', 'upgrade', 'opencodon', 'version', 'system', 'restart'],
            label: cc.updateOpencodon,
