...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/opencodon'
...
const VERSION = 3
const PREFIX = 'HML' // "Opencodon Memory Loadout" — namespaces our codes like WoW's leading bytes.
