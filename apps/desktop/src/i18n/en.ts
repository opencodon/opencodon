...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'Opencodon is not installed on the remote host. Install it there (curl -fsSL https://opencodon-agent.nousresearch.com/install.sh | sh) or set the Opencodon path.',
      sshErrPlatform:
