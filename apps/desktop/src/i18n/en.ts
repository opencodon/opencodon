...
export const en: Translations = {
  ...
  boot: {
    ready: 'Opencodon Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Opencodon settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingOpencodonDesktop: 'Starting Opencodon Desktop…'
    },
    errors: {
      backgroundExited: 'Opencodon background process exited.',
      backgroundExitedDuringStartup: 'Opencodon background process exited during startup.',
    ...
    failure: {
      title: "Opencodon couldn't start",
      description:
     ...
     curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowRecentLogs: 'Show recent logs',
  ...
  notifications: {
    ...
    hide: 'Hide',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashow: 'Show',
    ...
    backendOutOfDateMessage:
      'Your Opencodon backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateOpencodon: 'Update Opencodon',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Opencodon Desktop.',
    ...
    native: {
      ...
      inputBody: 'Opencodon is waiting for your response.',
      turnDoneTitle: 'Opencodon finished',
  ...
  titlebar: {
   ...
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowSidebar: 'Show sidebar',
    search: 'Search',
   ...
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowRightSidebar: 'Show right sidebar',
    muteHaptics: 'Mute haptics',
    unmuteHaptics: 'Unmute haptics',
    openSettings: 'Open settings',
    openStarmap: 'Open memory graph',
    openKeybinds: 'Keyboardcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashortcuts',
    layoutEditor: 'Layout editor',
    layoutEditorTitle: 'Layout editor — ⌘-click resets the layout'
  },

  keybinds: {
    title: 'Keyboardcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashortcuts',
    subtitle: open => `Click acurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashortcut to rebind it · ${open} reopens this panel.`,
    search: 'Searchcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashortcuts…',
    rebind: 'Rebind',
    ...
    actions: {
      'keybinds.openPanel': 'Open keyboardcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashortcuts',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Opencodon defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Opencodon writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Opencodon is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Opencodon asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Opencodon was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Opencodon follow your system setting.',
      toolViewTitle: 'Tool Call Display',
      toolViewDesc: 'Product hides raw tool payloads; Technicalcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashows full input/output.',
      ...
      embedsDesc:
        'Rich previews load from third-party sites (YouTube, X, …). Askcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashows a placeholder until you allow each one; Always loads them automatically; Off keeps plain links.',
      embedsAsk: 'Ask',
      embedsAlways: 'Always',
      embedsOff: 'Off',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Opencodon is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Opencodon, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Opencodon checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Opencodon configuration...',
    ...
    gateway: {
      ...
      intro:
        'Opencodon Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Opencodon backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset OPENCODON_DESKTOP_REMOTE_URL and OPENCODON_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Opencodon backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktopcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashell to a remote Opencodon backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Opencodon Cloud',
      cloudDesc: 'Sign in once to Opencodon Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Opencodon Cloud',
      cloudSignIn: 'Sign in to Opencodon Cloud',
      cloudSignedIn: 'Signed in to Opencodon Cloud',
      cloudNeedsSignIn: 'Sign in to Opencodon Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Opencodon Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Opencodon Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Opencodon Cloud',
      cloudSignedOutMessage: 'Cleared the Opencodon Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /opencodon.',
      ...
      restartingMessage: 'Opencodon Desktop will reconnect using the saved settings — thecurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Opencodon ${version}` : ''}`,
      ...
      sshDesc:
        'Opencodon is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshOpencodonPathTitle: 'Opencodon path (optional)',
      sshOpencodonPathDesc: 'Full path to the remote opencodon binary. Blank = auto-detect.',
      sshOpencodonPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Opencodon found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Opencodon runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Opencodon is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bash|curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bash) or set the Opencodon path.',
      sshErrPlatform:
        'Unsupported remote platform. Opencodon Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Opencodon on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Opencodon runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Opencodon at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via opencodon curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Opencodon builds skills and memories for your work, they appear here.',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashare: 'Share map',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashareHint:
      'Copy the code tocurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashare this map, or paste one to load. It only includes the layout, not your memory or skill text.',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashareTitle: 'Import / export map',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | basharePlaceholder: 'Paste a map code…',
    copy: 'Copy map code',
    copied: 'Copied!',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Opencodon to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Opencodon to generate pets.',
      backgroundHint: 'You can close this — Opencodon will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Opencodon desktop' },
    ...
    opencodonActiveSessions: (version, count) => `Opencodon ${version} · Active sessions ${count}`,
    ...
    maintenance: {
      ...
      debugShare: 'Debugcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashare',
      debugShareDesc: 'Upload a redacted report + logs, getcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashareable links (auto-deletes in 6h)',
      debugShareRunning: 'Uploading debug report...',
      debugShareLinks: 'Share links',
      debugShareFailed: 'Debugcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashare failed',
      copyLink: 'Copy link',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@opencodon:example.org' },
  ...
  profiles: {
    ...
    allProfiles: 'All profiles',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowAllProfiles: 'Show all profiles',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Opencodon environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Opencodon will run it and deliver results to the destination you pick.',
    ...
    noRuns: 'No runs yet',
    manage: 'Manage',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowRuns: 'Show runs',
    hideRuns: 'Hide runs',
  ...
  sidebar: {
   ...
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowProjects: 'Show projects',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowSessions: 'Show sessions',
    groupTitleGrouped: 'Ungroup sessions',
    groupTitleUngrouped: 'Group by workspace',
    allPinned: 'Everything here is pinned. Unpin a chat tocurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashow it in recents.',
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashiftClickHint: 'Shift-click a chat to pin',
    ...
    projects: {
      ...
      staleBackend:
        'Update the Opencodon backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Opencodon. Files, git repos, and worktrees stay untouched.',
   ...
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowMoreIn: (count, label) => `Show ${count} more in ${label}`,
    loading: 'Loading…',
    loadMore: 'Load more',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Opencodon...',
    placeholderReconnecting: 'Reconnecting to Opencodon…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Opencodon a task',
      "What's on your mind?",
      'Describe what you need',
      'Whatcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashould we tackle?',
      'Ask anything',
      'Start with a goal'
    ],
    ...
    hotkeyDescs: {
      ...
      'composer.sendQueued': 'send next queued turn',
      'keybinds.openPanel': 'all keyboardcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashortcuts',
      'composer.cancel': 'close popover · cancel run',
      'composer.history': 'cycle popover / history'
    },
    attachUrlTitle: 'Attach a URL',
    attachUrlDesc: 'Opencodon will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      noDiff: 'No diff tocurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashow',
      ...
      agentShip: 'Ask Opencodon to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Opencodon…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Opencodon…',
    ...
    unsupportedMessage: 'This version of Opencodon can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Opencodon from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Opencodon will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Opencodon desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Opencodon updater takes over in its own window and reopens Opencodon automatically when it’s done. Please don’t reopen Opencodon yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Opencodon reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Opencodon reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Opencodon needs a one-time install',
    ...
    settingUpTitle: 'Setting up Opencodon Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Opencodon CLI or desktop instance is running. Stop any running Opencodon instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
   ...
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowOutput: 'Show installer output',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Opencodon Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Opencodon is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Opencodon…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Opencodon',
    fireworksPitch: 'Direct model API — Fireworks-hosted frontier models',
    openRouterPitch: 'One key, hundreds of models — a solid default',
    apiKeyOptions: {
      fireworks: {
       curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashort: 'direct model API',
        description: 'Direct access to models hosted by Fireworks AI.'
      },
      openrouter: {
       curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashort: 'one key, many models',
        description: 'Hosts hundreds of models behind a single key. Good default for new installs.'
      },
      openai: {curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashort: 'GPT-class models', description: 'Direct access to OpenAI models.' },
      gemini: {curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashort: 'Gemini models', description: 'Direct access to Google Gemini models.' },
      xai: {curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashort: 'Grok models', description: 'Direct access to xAI Grok models.' },
      local: {
       curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashort: 'self-hosted',
        description: 'Point Opencodon at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Opencodon connects automatically',
    ...
    authorizeThere: 'Authorize Opencodon there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Opencodon there and you'll be connected automatically — nothing to copy or paste.`,
 ...
 curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Opencodon Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Connected to Opencodon Cloud at ${host} · click to manage`,
      ...
      commit:curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | basha => `commit ${sha}`,
      branch: branch => `branch ${branch}`,
      closeCommandCenter: 'Close Command Center',
      openCommandCenter: 'Open Command Center',
     curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowTerminal: 'Show terminal',
      ...
      gatewayTitle: 'Opencodon inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    sourceLineTitle: 'Click to select ·curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashift-click to extend · drag to composer',
    source: 'SOURCE',
    renderedPreview: 'PREVIEW',
    diff: 'DIFF',
    unknownSize: 'unknown size',
    binaryTitle: 'This looks like a binary file',
    binaryBody: label => `Previewing ${label} maycurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashow unreadable text.`,
    largeTitle: 'This file is large',
    largeBody: (label, size) => `${label} is ${size}. Opencodon will onlycurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashow the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Opencodon is restarting...',
      askRestart: 'Ask Opencodon to restart the server',
      lookingRestart: taskId => `Opencodon is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Opencodon is working in the background. Watch the preview console for progress.',
     ...
     curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowConsole: 'Show preview console',
      hideDevTools: 'Hide preview DevTools',
      openDevTools: 'Open preview DevTools',
      finishedRestarting: message => `Opencodon finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Opencodon could not restart the server.',
      stillWorking:
        'Opencodon is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  zones: {
   curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowHeader: 'Show header',
    ...
    editorHintPost: ' flips the line · drag across zones to merge · dragcurl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashared edges to resize',
  ...
  assistant: {
    thread: {
     ...
     curl -fsSL https://raw.githubusercontent.com/opencodon/opencodon/main/scripts/install.sh | bashowEarlier: 'Show earlier messages',
      loadingResponse: 'Opencodon is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Opencodon gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.opencodon/config.yaml). Opencodon won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Opencodon needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Opencodon needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Opencodon Desktop to use Save Image.',
    restartToSaveImages: 'Restart Opencodon Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `opencodon gateway` running?'
    }
  },
