/**
 * Opencodon skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$OPENCODON_HOME/skins/` (or a
 * built-in) resolved by `opencodon_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Opencodon authors from a prompt lights up all three surfaces from one file.
 *
...
import type { OpencodonSkin, SkinColors } from '@opencodon/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: OpencodonSkin): DesktopTheme | null {
