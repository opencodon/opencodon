...
const desktopWindow = window as unknown as { opencodonDesktop?: Window['opencodonDesktop'] }
const initialOpencodonDesktop = desktopWindow.opencodonDesktop

function installDesktopBridge(partial: Partial<Window['opencodonDesktop']> = {}) {
  desktopWindow.opencodonDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['opencodonDesktop']
}
...
afterEach(() => {
  ...
  if (initialOpencodonDesktop) {
    desktopWindow.opencodonDesktop = initialOpencodonDesktop
  } else {
    delete desktopWindow.opencodonDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['opencodonDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['opencodonDesktop']['openExternal'] })
