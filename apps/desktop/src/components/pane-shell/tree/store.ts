...
const STORAGE_KEY = 'opencodon.desktop.layoutTree.v2'

writeKey('opencodon.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('opencodon.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('opencodon.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'opencodon.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'opencodon.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__OPENCODON_LAYOUT_TREE__ = {
    close: closeTreePane,
