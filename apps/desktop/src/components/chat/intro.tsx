...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Opencodon look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Opencodon need to see?`,
    ...
    {
      headline: `What should ${label} Opencodon tackle?`,
...
const WORDMARK = 'OPENCODON AGENT'
