 ...
 *
 * A public install can end up with `origin=git@github.com:opencodon/opencodon.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/opencodon/opencodon.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/opencodon/opencodon'
