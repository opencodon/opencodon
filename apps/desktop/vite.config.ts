...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\opencodon\opencodon-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@opencodon/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@opencodon/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@opencodon/shared': path.resolve(__dirname, '../shared/src'),
