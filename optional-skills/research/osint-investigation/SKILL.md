...
author: opencodon (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  opencodon:
...
# $OPENCODON_OSINT_CACHE/icij/ (default: ~/.cache/opencodon-osint/icij/).
...
# Set OPENCODON_OSINT_UA=your-app/1.0 (your@email) to identify yourself
