"""Compatibility shim — the real module is ``opencodon.common.logging_setup``.
...
state stay coherent. New code must import from ``opencodon.common.logging_setup``.
Deleted in Phase 5.
"""

import sys

import opencodon.common.logging_setup as _real
